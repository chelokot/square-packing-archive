...
noncomputable def final01Points : Fin 15 → Point := finalPoints (choicePattern 1)

def final01Region (index : Fin 34) (center : Point) : Prop :=
  ...
  | 2 => 0 ≤ ((-37 / 50 : ℝ) * center.x + (-3 / 5 : ℝ) * center.y + (223 / 125 : ℝ)) ∧ 0 ≤ ((37 / 50 : ℝ) * center.x + (-43 / 500 : ℝ) * center.y + (-14759 / 25000 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (343 / 500 : ℝ) * center.y + (-343 / 500 : ℝ))
  ...
  | 4 => 0 ≤ ((43 / 500 : ℝ) * center.x + (37 / 50 : ℝ) * center.y + (-23359 / 25000 : ℝ)) ∧ 0 ≤ ((-343 / 500 : ℝ) * center.x + (0 : ℝ) * center.y + (1029 / 500 : ℝ)) ∧ 0 ≤ ((3 / 5 : ℝ) * center.x + (-37 / 50 : ℝ) * center.y + (-77 / 125 : ℝ))
  ...
  | 16 => 0 ≤ ((-43 / 500 : ℝ) * center.x + (-3 / 5 : ℝ) * center.y + (1211 / 625 : ℝ)) ∧ 0 ≤ ((413 / 500 : ℝ) * center.x + (0 : ℝ) * center.y + (-413 / 500 : ℝ)) ∧ 0 ≤ ((-37 / 50 : ℝ) * center.x + (3 / 5 : ℝ) * center.y + (-77 / 125 : ℝ))
  | 17 => 0 ≤ ((3 / 5 : ℝ) * center.x + (37 / 50 : ℝ) * center.y + (-447 / 125 : ℝ)) ∧ 0 ≤ ((-343 / 500 : ℝ) * center.x + (0 : ℝ) * center.y + (1029 / 500 : ℝ)) ∧ 0 ≤ ((43 / 500 : ℝ) * center.x + (-37 / 50 : ℝ) * center.y + (50641 / 25000 : ℝ))
  | 18 => 0 ≤ ((1 : ℝ) * center.x + (0 : ℝ) * center.y + (-8 / 5 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * center.x + (0 : ℝ) * center.y + (113 / 50 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-33 / 50 : ℝ) * center.y + (33 / 50 : ℝ))
  | 19 => 0 ≤ ((1 : ℝ) * center.x + (0 : ℝ) * center.y + (-113 / 50 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * center.x + (0 : ℝ) * center.y + (3 : ℝ)) ∧ 0 ≤ ((-43 / 500 : ℝ) * center.x + (-37 / 50 : ℝ) * center.y + (23359 / 25000 : ℝ))
  | 20 => 0 ≤ ((1 : ℝ) * center.x + (0 : ℝ) * center.y + (-457 / 500 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * center.x + (0 : ℝ) * center.y + (8 / 5 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-343 / 500 : ℝ) * center.y + (343 / 500 : ℝ))
  | 21 => 0 ≤ ((0 : ℝ) * center.x + (1 : ℝ) * center.y + (-87 / 50 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-1 : ℝ) * center.y + (113 / 50 : ℝ)) ∧ 0 ≤ ((-13 / 25 : ℝ) * center.x + (0 : ℝ) * center.y + (13 / 25 : ℝ))
  | 22 => 0 ≤ ((0 : ℝ) * center.x + (1 : ℝ) * center.y + (-113 / 50 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-1 : ℝ) * center.y + (1543 / 500 : ℝ)) ∧ 0 ≤ ((-413 / 500 : ℝ) * center.x + (0 : ℝ) * center.y + (413 / 500 : ℝ))
  | 23 => 0 ≤ ((0 : ℝ) * center.x + (1 : ℝ) * center.y + (-1 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-1 : ℝ) * center.y + (87 / 50 : ℝ)) ∧ 0 ≤ ((-37 / 50 : ℝ) * center.x + (43 / 500 : ℝ) * center.y + (14759 / 25000 : ℝ))
  | 24 => 0 ≤ ((1 : ℝ) * center.x + (0 : ℝ) * center.y + (-8 / 5 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * center.x + (0 : ℝ) * center.y + (113 / 50 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (33 / 50 : ℝ) * center.y + (-99 / 50 : ℝ))
  | 25 => 0 ≤ ((1 : ℝ) * center.x + (0 : ℝ) * center.y + (-113 / 50 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * center.x + (0 : ℝ) * center.y + (3 : ℝ)) ∧ 0 ≤ ((-43 / 500 : ℝ) * center.x + (37 / 50 : ℝ) * center.y + (-50641 / 25000 : ℝ))
  | 26 => 0 ≤ ((1 : ℝ) * center.x + (0 : ℝ) * center.y + (-1 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * center.x + (0 : ℝ) * center.y + (8 / 5 : ℝ)) ∧ 0 ≤ ((43 / 500 : ℝ) * center.x + (3 / 5 : ℝ) * center.y + (-1211 / 625 : ℝ))
  | 27 => 0 ≤ ((0 : ℝ) * center.x + (1 : ℝ) * center.y + (-8 / 5 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-1 : ℝ) * center.y + (12 / 5 : ℝ)) ∧ 0 ≤ ((4 / 5 : ℝ) * center.x + (0 : ℝ) * center.y + (-12 / 5 : ℝ))
  | 28 => 0 ≤ ((0 : ℝ) * center.x + (1 : ℝ) * center.y + (-12 / 5 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-1 : ℝ) * center.y + (1543 / 500 : ℝ)) ∧ 0 ≤ ((343 / 500 : ℝ) * center.x + (0 : ℝ) * center.y + (-1029 / 500 : ℝ))
  | 29 => 0 ≤ ((0 : ℝ) * center.x + (1 : ℝ) * center.y + (-457 / 500 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-1 : ℝ) * center.y + (8 / 5 : ℝ)) ∧ 0 ≤ ((343 / 500 : ℝ) * center.x + (0 : ℝ) * center.y + (-1029 / 500 : ℝ))
  | 30 => 0 ≤ ((-1 : ℝ) * center.x + (0 : ℝ) * center.y + (457 / 500 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-1 : ℝ) * center.y + (1 : ℝ))
  | 31 => 0 ≤ ((1 : ℝ) * center.x + (0 : ℝ) * center.y + (-3 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-1 : ℝ) * center.y + (457 / 500 : ℝ))
  | 32 => 0 ≤ ((-1 : ℝ) * center.x + (0 : ℝ) * center.y + (1 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (1 : ℝ) * center.y + (-1543 / 500 : ℝ))
  | _ => 0 ≤ ((1 : ℝ) * center.x + (0 : ℝ) * center.y + (-3 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (1 : ℝ) * center.y + (-1543 / 500 : ℝ))

set_option maxHeartbeats 4000000 in
lemma final01_hit_boundary (square : PlacedSquare) (fits : square.Fits 4)
    (index : Fin 34) (membership : final01Region index square.center) :
    (∃ index, square.Contains (final01Points index)) := by
  fin_cases index
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 0) (final01Points 1) (final01Points 4)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap]) (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap]) with first_inside | second_inside | third_inside
    · exact ⟨0, first_inside⟩
    · exact ⟨1, second_inside⟩
    · exact ⟨4, third_inside⟩
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 0) (final01Points 4) (final01Points 3)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 0) (final01Points 3) (final01Points 11)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 1) (final01Points 2) (final01Points 5)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 1) (final01Points 12) (final01Points 2)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 1) (final01Points 5) (final01Points 4)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 2) (final01Points 8) (final01Points 5)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 3) (final01Points 4) (final01Points 9)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 3) (final01Points 4) (final01Points 10)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 3) (final01Points 10) (final01Points 9)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 4) (final01Points 5) (final01Points 10)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 4) (final01Points 10) (final01Points 9)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 5) (final01Points 8) (final01Points 7)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 5) (final01Points 7) (final01Points 10)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 6) (final01Points 10) (final01Points 7)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 6) (final01Points 9) (final01Points 10)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 6) (final01Points 13) (final01Points 9)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (final01Points 7) (final01Points 8) (final01Points 14)
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    ...
    ·
      refine ⟨0, ?_⟩
      norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨1, ?_⟩
      norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    have pair := Stromquist.TenPoints.contains_short_pair (square := square)
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    ...
    ·
      refine ⟨3, ?_⟩
      apply (square.swap_contains_iff (final01Points 3)).1
      norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨9, ?_⟩
      apply (square.swap_contains_iff (final01Points 9)).1
      norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    have pair := (square.swap).contains_bottomSharpPair (left := (113 / 50 : ℝ))
    ...
    ·
      refine ⟨13, ?_⟩
      apply (square.swap_contains_iff (final01Points 13)).1
      norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    have pair := Stromquist.TenPoints.contains_short_pair (square := (square.swap))
    ...
    ·
      refine ⟨11, ?_⟩
      apply (square.swap_contains_iff (final01Points 11)).1
      norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨3, ?_⟩
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    ...
    ·
      refine ⟨6, ?_⟩
      apply (square.reflectY_contains_iff 4 (final01Points 6)).1
      norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨7, ?_⟩
      apply (square.reflectY_contains_iff 4 (final01Points 7)).1
      norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    have pair := Stromquist.TenPoints.contains_short_pair (square := (square.reflectY 4))
    ...
    ·
      refine ⟨14, ?_⟩
      apply (square.reflectY_contains_iff 4 (final01Points 14)).1
      norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    have pair := Stromquist.TenPoints.contains_short_pair (square := (square.reflectY 4))
    ...
    ·
      refine ⟨13, ?_⟩
      apply (square.reflectY_contains_iff 4 (final01Points 13)).1
      norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨6, ?_⟩
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    ...
    ·
      refine ⟨2, ?_⟩
      apply (square.reflectX_contains_iff 4 (final01Points 2)).1
      apply ((square.reflectX 4).swap_contains_iff ((final01Points 2).reflectX 4)).1
      norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨8, ?_⟩
      apply (square.reflectX_contains_iff 4 (final01Points 8)).1
      apply ((square.reflectX 4).swap_contains_iff ((final01Points 8).reflectX 4)).1
      norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    have pair := Stromquist.TenPoints.contains_short_pair (square := ((square.reflectX 4).swap))
    ...
    ·
      refine ⟨14, ?_⟩
      apply (square.reflectX_contains_iff 4 (final01Points 14)).1
      apply ((square.reflectX 4).swap_contains_iff ((final01Points 14).reflectX 4)).1
      norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    have pair := Stromquist.TenPoints.contains_short_pair (square := ((square.reflectX 4).swap))
    ...
    ·
      refine ⟨12, ?_⟩
      apply (square.reflectX_contains_iff 4 (final01Points 12)).1
      apply ((square.reflectX 4).swap_contains_iff ((final01Points 12).reflectX 4)).1
      norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨2, ?_⟩
  ...
  · rcases membership with ⟨bound_0, bound_1⟩
    have inside := square.contains_cornerPoint (targetX := (457 / 500 : ℝ))
      ...
      (by linarith only [bound_1])
    refine ⟨11, ?_⟩
    norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at inside ⊢
    exact inside
  · rcases membership with ⟨bound_0, bound_1⟩
    ...
    exact inside
  · rcases membership with ⟨bound_0, bound_1⟩
    have inside := (square.reflectY 4).contains_cornerPoint (targetX := (1 : ℝ))
      (targetY := (457 / 500 : ℝ)) ((square.reflectY_fits_iff 4).2 fits) (by norm_num) (by norm_num)
      (by dsimp [PlacedSquare.reflectX, PlacedSquare.reflectY, Point.reflectX, Point.reflectY]; linarith only [bound_0])
      (by dsimp [PlacedSquare.reflectX, PlacedSquare.reflectY, Point.reflectX, Point.reflectY]; linarith only [bound_1])
    refine ⟨13, ?_⟩
    apply (square.reflectY_contains_iff 4 (final01Points 13)).1
    ...
    exact inside
  · rcases membership with ⟨bound_0, bound_1⟩
    have inside := ((square.reflectX 4).reflectY 4).contains_cornerPoint (targetX := (1 : ℝ))
      (targetY := (457 / 500 : ℝ)) (((square.reflectX 4).reflectY_fits_iff 4).2 ((square.reflectX_fits_iff 4).2 fits)) (by norm_num) (by norm_num)
      (by dsimp [PlacedSquare.reflectX, PlacedSquare.reflectY, Point.reflectX, Point.reflectY]; linarith only [bound_0])
      (by dsimp [PlacedSquare.reflectX, PlacedSquare.reflectY, Point.reflectX, Point.reflectY]; linarith only [bound_1])
    refine ⟨14, ?_⟩
    apply (square.reflectX_contains_iff 4 (final01Points 14)).1
    apply ((square.reflectX 4).reflectY_contains_iff 4 ((final01Points 14).reflectX 4)).1
    norm_num [final01Points, finalPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at inside ⊢
    exact inside

set_option maxHeartbeats 4000000 in
theorem final01_cover : ∀ square : PlacedSquare, square.Fits 4 → (∃ index, square.Contains (final01Points index)) := by
  intro square fits
  ...
  ·
    ...
    ·
      ...
      ·
        apply final01_hit_boundary square fits 3
      ...
      ·
        ...
        by_cases branch_3 : 0 ≤ ((-343 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (1029 / 500 : ℝ))
        ·
          by_cases branch_4 : 0 ≤ ((43 / 500 : ℝ) * square.center.x + (37 / 50 : ℝ) * square.center.y + (-23359 / 25000 : ℝ))
          ·
            apply final01_hit_boundary square fits 4
            change 0 ≤ ((43 / 500 : ℝ) * square.center.x + (37 / 50 : ℝ) * square.center.y + (-23359 / 25000 : ℝ)) ∧ 0 ≤ ((-343 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (1029 / 500 : ℝ)) ∧ 0 ≤ ((3 / 5 : ℝ) * square.center.x + (-37 / 50 : ℝ) * square.center.y + (-77 / 125 : ℝ))
            refine ⟨?_ , ?_ , ?_ ⟩
            ·
              exact branch_4
            ·
          ...
          ·
            have branch_4_negative : 0 < ((-43 / 500 : ℝ) * square.center.x + (-37 / 50 : ℝ) * square.center.y + (23359 / 25000 : ℝ)) := by linarith only [branch_4]
            apply final01_hit_boundary square fits 19
            change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-113 / 50 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 : ℝ)) ∧ 0 ≤ ((-43 / 500 : ℝ) * square.center.x + (-37 / 50 : ℝ) * square.center.y + (23359 / 25000 : ℝ))
            refine ⟨?_ , ?_ , ?_ ⟩
            ·
              exact branch_0
            ·
              ...
              have identity : (1 : ℝ) * ((-343 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (1029 / 500 : ℝ)) + (343 / 500 : ℝ) * ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-3 : ℝ)) = (0 : ℝ) := by
                ring
              nlinarith only [weighted_0, weighted_1, identity]
            ·
              exact branch_4_negative.le
        ·
          have branch_3_negative : 0 < ((343 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-1029 / 500 : ℝ)) := by linarith only [branch_3]
          by_cases branch_5 : 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-457 / 500 : ℝ))
          ·
            apply final01_hit_boundary square fits 29
            change 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-457 / 500 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (8 / 5 : ℝ)) ∧ 0 ≤ ((343 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-1029 / 500 : ℝ))
            refine ⟨?_ , ?_ , ?_ ⟩
            ·
              exact branch_5
            ·
          ...
          ·
            have branch_5_negative : 0 < ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (457 / 500 : ℝ)) := by linarith only [branch_5]
            apply final01_hit_boundary square fits 31
    ...
    ·
      ...
      ·
        by_cases branch_7 : 0 ≤ ((-343 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (1029 / 500 : ℝ))
        ·
          apply final01_hit_boundary square fits 6
          ...
          ·
            by_contra! failed
            have negative : 0 < ((4 / 5 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-12 / 5 : ℝ)) := by linarith only [failed]
            have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (4 / 5 : ℝ)) branch_7
            have weighted_1 := mul_pos (by norm_num : 0 < (343 / 500 : ℝ)) negative
            have identity : (4 / 5 : ℝ) * ((-343 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (1029 / 500 : ℝ)) + (343 / 500 : ℝ) * ((4 / 5 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-12 / 5 : ℝ)) = (0 : ℝ) := by
              ring
            nlinarith only [weighted_0, weighted_1, identity]
          ·
            exact branch_6
        ...
        ·
          have branch_7_negative : 0 < ((343 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-1029 / 500 : ℝ)) := by linarith only [branch_7]
          ...
          ·
            ...
            ·
              apply final01_hit_boundary square fits 27
              ...
              ·
                by_contra! failed
                have negative : 0 < ((-4 / 5 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (12 / 5 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_pos (by norm_num : 0 < (4 / 5 : ℝ)) branch_7_negative
                have weighted_1 := mul_pos (by norm_num : 0 < (343 / 500 : ℝ)) negative
                have identity : (4 / 5 : ℝ) * ((343 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-1029 / 500 : ℝ)) + (343 / 500 : ℝ) * ((-4 / 5 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (12 / 5 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, identity]
            ·
              ...
              apply final01_hit_boundary square fits 28
              change 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-12 / 5 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (1543 / 500 : ℝ)) ∧ 0 ≤ ((343 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-1029 / 500 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ·
                exact branch_9_negative.le
              ·
                by_contra! failed
                have negative : 0 < ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-1543 / 500 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (2 / 5 : ℝ)) container_1
                have weighted_1 := mul_nonneg (by norm_num : 0 ≤ (1 : ℝ)) branch_6
                have weighted_2 := mul_pos (by norm_num : 0 < (37 / 50 : ℝ)) negative
                have identity : (2 / 5 : ℝ) * ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (4 : ℝ)) + (1 : ℝ) * ((2 / 5 : ℝ) * square.center.x + (-37 / 50 : ℝ) * square.center.y + (72 / 125 : ℝ)) + (37 / 50 : ℝ) * ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-1543 / 500 : ℝ)) = (-2691 / 25000 : ℝ) := by
                  ring
                have constant_negative := (by norm_num : 0 < (2691 / 25000 : ℝ))
          ...
          ·
            ...
            ·
              ...
              have weighted_2 := mul_pos (by norm_num : 0 < (37 / 50 : ℝ)) negative
              have identity : (2 / 5 : ℝ) * ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (4 : ℝ)) + (1 : ℝ) * ((2 / 5 : ℝ) * square.center.x + (37 / 50 : ℝ) * square.center.y + (-298 / 125 : ℝ)) + (37 / 50 : ℝ) * ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (457 / 500 : ℝ)) = (-2691 / 25000 : ℝ) := by
                ring
              have constant_negative := (by norm_num : 0 < (2691 / 25000 : ℝ))
              nlinarith only [weighted_0, weighted_1, weighted_2, constant_negative, identity]
            ·
      ...
      ·
        ...
        ·
          apply final01_hit_boundary square fits 12
        ...
        ·
          ...
          by_cases branch_11 : 0 ≤ ((-4 / 5 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (12 / 5 : ℝ))
          ·
            by_cases branch_12 : 0 ≤ ((43 / 500 : ℝ) * square.center.x + (-37 / 50 : ℝ) * square.center.y + (50641 / 25000 : ℝ))
            ·
              apply final01_hit_boundary square fits 17
              change 0 ≤ ((3 / 5 : ℝ) * square.center.x + (37 / 50 : ℝ) * square.center.y + (-447 / 125 : ℝ)) ∧ 0 ≤ ((-343 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (1029 / 500 : ℝ)) ∧ 0 ≤ ((43 / 500 : ℝ) * square.center.x + (-37 / 50 : ℝ) * square.center.y + (50641 / 25000 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ·
                exact branch_10_negative.le
              ·
                by_contra! failed
                have negative : 0 < ((343 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-1029 / 500 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (343 / 500 : ℝ)) branch_11
                have weighted_1 := mul_pos (by norm_num : 0 < (4 / 5 : ℝ)) negative
                have identity : (343 / 500 : ℝ) * ((-4 / 5 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (12 / 5 : ℝ)) + (4 / 5 : ℝ) * ((343 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-1029 / 500 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, identity]
              ·
                exact branch_12
            ·
              have branch_12_negative : 0 < ((-43 / 500 : ℝ) * square.center.x + (37 / 50 : ℝ) * square.center.y + (-50641 / 25000 : ℝ)) := by linarith only [branch_12]
              apply final01_hit_boundary square fits 25
              change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-113 / 50 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 : ℝ)) ∧ 0 ≤ ((-43 / 500 : ℝ) * square.center.x + (37 / 50 : ℝ) * square.center.y + (-50641 / 25000 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ·
                exact branch_0
              ·
                ...
                have weighted_1 := mul_pos (by norm_num : 0 < (4 / 5 : ℝ)) negative
                have identity : (1 : ℝ) * ((-4 / 5 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (12 / 5 : ℝ)) + (4 / 5 : ℝ) * ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-3 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, identity]
              ·
                exact branch_12_negative.le
          ·
            have branch_11_negative : 0 < ((4 / 5 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-12 / 5 : ℝ)) := by linarith only [branch_11]
            by_cases branch_13 : 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (1543 / 500 : ℝ))
            ·
              apply final01_hit_boundary square fits 28
              change 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-12 / 5 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (1543 / 500 : ℝ)) ∧ 0 ≤ ((343 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-1029 / 500 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ...
              ·
                by_contra! failed
                have negative : 0 < ((-343 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (1029 / 500 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_pos (by norm_num : 0 < (343 / 500 : ℝ)) branch_11_negative
                have weighted_1 := mul_pos (by norm_num : 0 < (4 / 5 : ℝ)) negative
                have identity : (343 / 500 : ℝ) * ((4 / 5 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-12 / 5 : ℝ)) + (4 / 5 : ℝ) * ((-343 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (1029 / 500 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, identity]
            ·
              have branch_13_negative : 0 < ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-1543 / 500 : ℝ)) := by linarith only [branch_13]
              apply final01_hit_boundary square fits 33
              change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-3 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-1543 / 500 : ℝ))
              refine ⟨?_ , ?_ ⟩
              ·
                by_contra! failed
                have negative : 0 < ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 : ℝ)) := by linarith only [failed]
    ...
    ·
      ...
      ·
        ...
        ·
          ...
          ·
            apply final01_hit_boundary square fits 0
          ...
          ·
            ...
            ·
              apply final01_hit_boundary square fits 18
            ...
            ·
              ...
              apply final01_hit_boundary square fits 20
              ...
              ·
                ...
                have weighted_2 := mul_pos (by norm_num : 0 < (37 / 50 : ℝ)) negative
                have identity : (9 / 50 : ℝ) * ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (0 : ℝ)) + (1 : ℝ) * ((37 / 50 : ℝ) * square.center.x + (-9 / 50 : ℝ) * square.center.y + (-251 / 250 : ℝ)) + (37 / 50 : ℝ) * ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (457 / 500 : ℝ)) = (-8191 / 25000 : ℝ) := by
                  ring
              ...
              ·
                by_contra! failed
                have negative : 0 < ((0 : ℝ) * square.center.x + (343 / 500 : ℝ) * square.center.y + (-343 / 500 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_pos (by norm_num : 0 < (343 / 500 : ℝ)) branch_17_negative
                have weighted_1 := mul_pos (by norm_num : 0 < (33 / 50 : ℝ)) negative
                have identity : (343 / 500 : ℝ) * ((0 : ℝ) * square.center.x + (-33 / 50 : ℝ) * square.center.y + (33 / 50 : ℝ)) + (33 / 50 : ℝ) * ((0 : ℝ) * square.center.x + (343 / 500 : ℝ) * square.center.y + (-343 / 500 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, identity]
        ·
          have branch_16_negative : 0 < ((37 / 50 : ℝ) * square.center.x + (12 / 25 : ℝ) * square.center.y + (-5381 / 2500 : ℝ)) := by linarith only [branch_16]
          apply final01_hit_boundary square fits 5
      ...
      ·
        ...
        ·
          apply final01_hit_boundary square fits 1
        ...
        ·
          ...
          by_cases branch_20 : 0 ≤ ((0 : ℝ) * square.center.x + (33 / 50 : ℝ) * square.center.y + (-33 / 50 : ℝ))
          ·
            by_cases branch_21 : 0 ≤ ((37 / 50 : ℝ) * square.center.x + (-43 / 500 : ℝ) * square.center.y + (-14759 / 25000 : ℝ))
            ·
              apply final01_hit_boundary square fits 2
              change 0 ≤ ((-37 / 50 : ℝ) * square.center.x + (-3 / 5 : ℝ) * square.center.y + (223 / 125 : ℝ)) ∧ 0 ≤ ((37 / 50 : ℝ) * square.center.x + (-43 / 500 : ℝ) * square.center.y + (-14759 / 25000 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (343 / 500 : ℝ) * square.center.y + (-343 / 500 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ·
              ...
              ·
                by_contra! failed
                have negative : 0 < ((0 : ℝ) * square.center.x + (-343 / 500 : ℝ) * square.center.y + (343 / 500 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (343 / 500 : ℝ)) branch_20
                have weighted_1 := mul_pos (by norm_num : 0 < (33 / 50 : ℝ)) negative
                have identity : (343 / 500 : ℝ) * ((0 : ℝ) * square.center.x + (33 / 50 : ℝ) * square.center.y + (-33 / 50 : ℝ)) + (33 / 50 : ℝ) * ((0 : ℝ) * square.center.x + (-343 / 500 : ℝ) * square.center.y + (343 / 500 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, identity]
            ·
              have branch_21_negative : 0 < ((-37 / 50 : ℝ) * square.center.x + (43 / 500 : ℝ) * square.center.y + (14759 / 25000 : ℝ)) := by linarith only [branch_21]
              apply final01_hit_boundary square fits 23
          ...
          ·
            have branch_20_negative : 0 < ((0 : ℝ) * square.center.x + (-33 / 50 : ℝ) * square.center.y + (33 / 50 : ℝ)) := by linarith only [branch_20]
            by_cases branch_22 : 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-457 / 500 : ℝ))
            ·
              apply final01_hit_boundary square fits 20
              change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-457 / 500 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (8 / 5 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-343 / 500 : ℝ) * square.center.y + (343 / 500 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ...
              ·
                by_contra! failed
                have negative : 0 < ((0 : ℝ) * square.center.x + (343 / 500 : ℝ) * square.center.y + (-343 / 500 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_pos (by norm_num : 0 < (343 / 500 : ℝ)) branch_20_negative
                have weighted_1 := mul_pos (by norm_num : 0 < (33 / 50 : ℝ)) negative
                have identity : (343 / 500 : ℝ) * ((0 : ℝ) * square.center.x + (-33 / 50 : ℝ) * square.center.y + (33 / 50 : ℝ)) + (33 / 50 : ℝ) * ((0 : ℝ) * square.center.x + (343 / 500 : ℝ) * square.center.y + (-343 / 500 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, identity]
            ·
              have branch_22_negative : 0 < ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (457 / 500 : ℝ)) := by linarith only [branch_22]
              apply final01_hit_boundary square fits 30
    ...
    ·
      ...
      ·
        ...
        ·
          ...
          ·
            by_cases branch_26 : 0 ≤ ((13 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-13 / 25 : ℝ))
            ·
              apply final01_hit_boundary square fits 7
              ...
              ·
                exact branch_26
            ·
              have branch_26_negative : 0 < ((-13 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (13 / 25 : ℝ)) := by linarith only [branch_26]
              apply final01_hit_boundary square fits 21
          ...
          ·
            ...
            apply final01_hit_boundary square fits 11
        ...
        ·
          ...
          ·
            ...
            ·
              apply final01_hit_boundary square fits 10
            ...
            ·
              ...
              apply final01_hit_boundary square fits 13
      ...
      ·
        ...
        ·
          ...
          ·
            ...
            ·
              apply final01_hit_boundary square fits 14
            ...
            ·
              ...
              ·
                apply final01_hit_boundary square fits 24
              ...
              ·
                ...
                apply final01_hit_boundary square fits 26
                change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-1 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (8 / 5 : ℝ)) ∧ 0 ≤ ((43 / 500 : ℝ) * square.center.x + (3 / 5 : ℝ) * square.center.y + (-1211 / 625 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ·
                  by_contra! failed
                  ...
                  have weighted_2 := mul_pos (by norm_num : 0 < (37 / 50 : ℝ)) negative
                  have identity : (9 / 50 : ℝ) * ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (4 : ℝ)) + (1 : ℝ) * ((37 / 50 : ℝ) * square.center.x + (9 / 50 : ℝ) * square.center.y + (-431 / 250 : ℝ)) + (37 / 50 : ℝ) * ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (1 : ℝ)) = (-33 / 125 : ℝ) := by
                    ring
                ...
                ·
                  by_contra! failed
                  have negative : 0 < ((-43 / 500 : ℝ) * square.center.x + (-3 / 5 : ℝ) * square.center.y + (1211 / 625 : ℝ)) := by linarith only [failed]
                  have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (1419 / 25000 : ℝ)) branch_29
                  have weighted_1 := mul_pos (by norm_num : 0 < (10713 / 25000 : ℝ)) branch_31_negative
                  have weighted_2 := mul_pos (by norm_num : 0 < (1221 / 2500 : ℝ)) negative
                  have identity : (1419 / 25000 : ℝ) * ((37 / 50 : ℝ) * square.center.x + (9 / 50 : ℝ) * square.center.y + (-431 / 250 : ℝ)) + (10713 / 25000 : ℝ) * ((0 : ℝ) * square.center.x + (33 / 50 : ℝ) * square.center.y + (-99 / 50 : ℝ)) + (1221 / 2500 : ℝ) * ((-43 / 500 : ℝ) * square.center.x + (-3 / 5 : ℝ) * square.center.y + (1211 / 625 : ℝ)) = (0 : ℝ) := by
                    ring
                  nlinarith only [weighted_0, weighted_1, weighted_2, identity]
        ·
          ...
          ·
            apply final01_hit_boundary square fits 15
          ...
          ·
            ...
            by_cases branch_34 : 0 ≤ ((13 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-13 / 25 : ℝ))
            ·
              by_cases branch_35 : 0 ≤ ((-43 / 500 : ℝ) * square.center.x + (-3 / 5 : ℝ) * square.center.y + (1211 / 625 : ℝ))
              ·
                apply final01_hit_boundary square fits 16
                change 0 ≤ ((-43 / 500 : ℝ) * square.center.x + (-3 / 5 : ℝ) * square.center.y + (1211 / 625 : ℝ)) ∧ 0 ≤ ((413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-413 / 500 : ℝ)) ∧ 0 ≤ ((-37 / 50 : ℝ) * square.center.x + (3 / 5 : ℝ) * square.center.y + (-77 / 125 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ·
                  exact branch_35
                ·
                  by_contra! failed
                  have negative : 0 < ((-413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (413 / 500 : ℝ)) := by linarith only [failed]
                  have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (413 / 500 : ℝ)) branch_34
                  have weighted_1 := mul_pos (by norm_num : 0 < (13 / 25 : ℝ)) negative
                  have identity : (413 / 500 : ℝ) * ((13 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-13 / 25 : ℝ)) + (13 / 25 : ℝ) * ((-413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (413 / 500 : ℝ)) = (0 : ℝ) := by
                    ring
                  nlinarith only [weighted_0, weighted_1, identity]
                ·
                  exact branch_33_negative.le
              ·
                have branch_35_negative : 0 < ((43 / 500 : ℝ) * square.center.x + (3 / 5 : ℝ) * square.center.y + (-1211 / 625 : ℝ)) := by linarith only [branch_35]
                apply final01_hit_boundary square fits 26
                change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-1 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (8 / 5 : ℝ)) ∧ 0 ≤ ((43 / 500 : ℝ) * square.center.x + (3 / 5 : ℝ) * square.center.y + (-1211 / 625 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ·
            ...
            ·
              have branch_34_negative : 0 < ((-13 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (13 / 25 : ℝ)) := by linarith only [branch_34]
              by_cases branch_36 : 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (1543 / 500 : ℝ))
              ·
                apply final01_hit_boundary square fits 22
                change 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-113 / 50 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (1543 / 500 : ℝ)) ∧ 0 ≤ ((-413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (413 / 500 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ·
                  by_contra! failed
                  have negative : 0 < ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (113 / 50 : ℝ)) := by linarith only [failed]
                ...
                ·
                  by_contra! failed
                  have negative : 0 < ((413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-413 / 500 : ℝ)) := by linarith only [failed]
                  have weighted_0 := mul_pos (by norm_num : 0 < (413 / 500 : ℝ)) branch_34_negative
                  have weighted_1 := mul_pos (by norm_num : 0 < (13 / 25 : ℝ)) negative
                  have identity : (413 / 500 : ℝ) * ((-13 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (13 / 25 : ℝ)) + (13 / 25 : ℝ) * ((413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-413 / 500 : ℝ)) = (0 : ℝ) := by
                    ring
                  nlinarith only [weighted_0, weighted_1, identity]
              ·
                have branch_36_negative : 0 < ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-1543 / 500 : ℝ)) := by linarith only [branch_36]
                apply final01_hit_boundary square fits 32
                change 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (1 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-1543 / 500 : ℝ))
                refine ⟨?_ , ?_ ⟩
                ·
                  by_contra! failed
                  have negative : 0 < ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-1 : ℝ)) := by linarith only [failed]
