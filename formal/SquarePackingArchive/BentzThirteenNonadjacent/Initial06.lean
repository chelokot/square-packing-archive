...
noncomputable def initial06Points : Fin 14 → Point := initialPoints (choicePattern 6)

def initial06Region (index : Fin 28) (center : Point) : Prop :=
...
lemma initial06_hit_boundary (square : PlacedSquare) (fits : square.Fits 4)
    (index : Fin 28) (membership : initial06Region index square.center) :
    (∃ index, square.Contains (initial06Points index)) ∨ Hole square.center := by
  fin_cases index
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial06Points 0) (initial06Points 6) (initial06Points 4)
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap]) (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap]) with first_inside | second_inside | third_inside
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial06Points 0) (initial06Points 10) (initial06Points 6)
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial06Points 1) (initial06Points 4) (initial06Points 7)
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial06Points 1) (initial06Points 7) (initial06Points 11)
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial06Points 2) (initial06Points 5) (initial06Points 8)
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial06Points 2) (initial06Points 8) (initial06Points 12)
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial06Points 3) (initial06Points 9) (initial06Points 5)
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial06Points 3) (initial06Points 13) (initial06Points 9)
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial06Points 4) (initial06Points 6) (initial06Points 7)
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial06Points 5) (initial06Points 9) (initial06Points 8)
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    ...
    ·
      refine ⟨6, ?_⟩
      norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨7, ?_⟩
      norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    have pair := Stromquist.TenPoints.contains_short_pair (square := square)
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    ...
    ·
      refine ⟨0, ?_⟩
      apply (square.swap_contains_iff (initial06Points 0)).1
      norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨2, ?_⟩
      apply (square.swap_contains_iff (initial06Points 2)).1
      norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    ...
    ·
      refine ⟨12, ?_⟩
      apply (square.swap_contains_iff (initial06Points 12)).1
      norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    ...
    ·
      refine ⟨10, ?_⟩
      apply (square.swap_contains_iff (initial06Points 10)).1
      norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨0, ?_⟩
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    ...
    ·
      refine ⟨8, ?_⟩
      apply (square.reflectY_contains_iff 4 (initial06Points 8)).1
      norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨9, ?_⟩
      apply (square.reflectY_contains_iff 4 (initial06Points 9)).1
      norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    ...
    ·
      refine ⟨13, ?_⟩
      apply (square.reflectY_contains_iff 4 (initial06Points 13)).1
      norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    ...
    ·
      refine ⟨12, ?_⟩
      apply (square.reflectY_contains_iff 4 (initial06Points 12)).1
      norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨8, ?_⟩
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    ...
    ·
      refine ⟨1, ?_⟩
      apply (square.reflectX_contains_iff 4 (initial06Points 1)).1
      apply ((square.reflectX 4).swap_contains_iff ((initial06Points 1).reflectX 4)).1
      norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨3, ?_⟩
      apply (square.reflectX_contains_iff 4 (initial06Points 3)).1
      apply ((square.reflectX 4).swap_contains_iff ((initial06Points 3).reflectX 4)).1
      norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    ...
    ·
      refine ⟨13, ?_⟩
      apply (square.reflectX_contains_iff 4 (initial06Points 13)).1
      apply ((square.reflectX 4).swap_contains_iff ((initial06Points 13).reflectX 4)).1
      norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    ...
    ·
      refine ⟨11, ?_⟩
      apply (square.reflectX_contains_iff 4 (initial06Points 11)).1
      apply ((square.reflectX 4).swap_contains_iff ((initial06Points 11).reflectX 4)).1
      norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨1, ?_⟩
  ...
  · rcases membership with ⟨bound_0, bound_1⟩
    ...
    have inside := square.contains_cornerPoint (targetX := (1 : ℝ))
      ...
      (by linarith only [bound_1])
    refine ⟨10, ?_⟩
    norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at inside ⊢
    exact inside
  · rcases membership with ⟨bound_0, bound_1⟩
    apply Or.inl
  ...
  · rcases membership with ⟨bound_0, bound_1⟩
    ...
    refine ⟨13, ?_⟩
    apply (square.reflectX_contains_iff 4 (initial06Points 13)).1
    apply ((square.reflectX 4).reflectY_contains_iff 4 ((initial06Points 13).reflectX 4)).1
    norm_num [initial06Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at inside ⊢
    exact inside
...
set_option maxHeartbeats 4000000 in
theorem initial06_cover : ∀ square : PlacedSquare, square.Fits 4 → (∃ index, square.Contains (initial06Points index)) ∨ Hole square.center := by
  intro square fits
  ...
  ·
    ...
    ·
      ...
      ·
        ...
        ·
          apply initial06_hit_boundary square fits 0
        ...
        ·
          ...
          ·
            apply initial06_hit_boundary square fits 8
          ...
          ·
            ...
            apply initial06_hit_boundary square fits 10
      ...
      ·
        ...
        ·
          ...
          ·
            apply initial06_hit_boundary square fits 1
          ...
          ·
            ...
            ·
              ...
              apply initial06_hit_boundary square fits 12
        ...
        ·
          ...
          ·
            apply initial06_hit_boundary square fits 15
          ...
          ·
            ...
            apply initial06_hit_boundary square fits 22
    ...
    ·
      ...
      ·
        ...
        ·
          apply initial06_hit_boundary square fits 2
      ...
      ·
        ...
        ·
          ...
          ·
            apply initial06_hit_boundary square fits 3
          ...
          ·
            ...
            apply initial06_hit_boundary square fits 21
        ...
        ·
          ...
          ·
            ...
            ·
              ...
              apply initial06_hit_boundary square fits 11
          ...
          ·
            ...
            apply initial06_hit_boundary square fits 23
  ...
  ·
    ...
    ·
      ...
      ·
        ...
        ·
          ...
          ·
            apply initial06_hit_boundary square fits 4
          ...
          ·
            ...
            ·
              apply initial06_hit_boundary square fits 9
            ...
            ·
              ...
              apply initial06_hit_boundary square fits 16
        ...
        ·
          ...
          ·
            ...
            ·
              apply initial06_hit_boundary square fits 5
            ...
            ·
              ...
              apply initial06_hit_boundary square fits 14
          ...
          ·
            ...
            ·
              ...
              ·
                ...
                apply initial06_hit_boundary square fits 18
            ...
            ·
              ...
              apply initial06_hit_boundary square fits 24
      ...
      ·
        ...
        ·
          ...
          ·
            apply initial06_hit_boundary square fits 6
        ...
        ·
          ...
          ·
            ...
            ·
              apply initial06_hit_boundary square fits 7
            ...
            ·
              ...
              ·
                ...
                apply initial06_hit_boundary square fits 17
          ...
          ·
            ...
            ·
              apply initial06_hit_boundary square fits 20
            ...
            ·
              ...
              apply initial06_hit_boundary square fits 25
    ...
    ·
      ...
      ·
        ...
        ·
          apply initial06_hit_boundary square fits 26
        ...
        ·
          ...
          apply initial06_hit_boundary square fits 13
      ...
      ·
        ...
        ·
          apply initial06_hit_boundary square fits 27
        ...
        ·
          ...
          apply initial06_hit_boundary square fits 19
