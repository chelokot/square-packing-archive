...
noncomputable def initial02Points : Fin 14 → Point := initialPoints (choicePattern 2)

def initial02Region (index : Fin 28) (center : Point) : Prop :=
  ...
  | 1 => 0 ≤ ((413 / 500 : ℝ) * center.x + (0 : ℝ) * center.y + (-413 / 500 : ℝ)) ∧ 0 ≤ ((-43 / 500 : ℝ) * center.x + (3 / 5 : ℝ) * center.y + (-289 / 625 : ℝ)) ∧ 0 ≤ ((-37 / 50 : ℝ) * center.x + (-3 / 5 : ℝ) * center.y + (223 / 125 : ℝ))
  ...
  | 3 => 0 ≤ ((37 / 50 : ℝ) * center.x + (-3 / 5 : ℝ) * center.y + (-147 / 125 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (343 / 500 : ℝ) * center.y + (-343 / 500 : ℝ)) ∧ 0 ≤ ((-37 / 50 : ℝ) * center.x + (-43 / 500 : ℝ) * center.y + (59241 / 25000 : ℝ))
  ...
  | 5 => 0 ≤ ((-37 / 50 : ℝ) * center.x + (3 / 5 : ℝ) * center.y + (-77 / 125 : ℝ)) ∧ 0 ≤ ((-43 / 500 : ℝ) * center.x + (-3 / 5 : ℝ) * center.y + (1211 / 625 : ℝ)) ∧ 0 ≤ ((413 / 500 : ℝ) * center.x + (0 : ℝ) * center.y + (-413 / 500 : ℝ))
  ...
  | 7 => 0 ≤ ((-413 / 500 : ℝ) * center.x + (0 : ℝ) * center.y + (1239 / 500 : ℝ)) ∧ 0 ≤ ((43 / 500 : ℝ) * center.x + (-3 / 5 : ℝ) * center.y + (996 / 625 : ℝ)) ∧ 0 ≤ ((37 / 50 : ℝ) * center.x + (3 / 5 : ℝ) * center.y + (-447 / 125 : ℝ))
  ...
  | 11 => 0 ≤ ((1 : ℝ) * center.x + (0 : ℝ) * center.y + (-12 / 5 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * center.x + (0 : ℝ) * center.y + (1543 / 500 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-343 / 500 : ℝ) * center.y + (343 / 500 : ℝ))
  | 12 => 0 ≤ ((1 : ℝ) * center.x + (0 : ℝ) * center.y + (-1 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * center.x + (0 : ℝ) * center.y + (8 / 5 : ℝ)) ∧ 0 ≤ ((43 / 500 : ℝ) * center.x + (-3 / 5 : ℝ) * center.y + (289 / 625 : ℝ))
  | 13 => 0 ≤ ((0 : ℝ) * center.x + (1 : ℝ) * center.y + (-87 / 50 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-1 : ℝ) * center.y + (113 / 50 : ℝ)) ∧ 0 ≤ ((-13 / 25 : ℝ) * center.x + (0 : ℝ) * center.y + (13 / 25 : ℝ))
  | 14 => 0 ≤ ((0 : ℝ) * center.x + (1 : ℝ) * center.y + (-113 / 50 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-1 : ℝ) * center.y + (1543 / 500 : ℝ)) ∧ 0 ≤ ((-413 / 500 : ℝ) * center.x + (0 : ℝ) * center.y + (413 / 500 : ℝ))
  | 15 => 0 ≤ ((0 : ℝ) * center.x + (1 : ℝ) * center.y + (-457 / 500 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-1 : ℝ) * center.y + (87 / 50 : ℝ)) ∧ 0 ≤ ((-413 / 500 : ℝ) * center.x + (0 : ℝ) * center.y + (413 / 500 : ℝ))
  | 16 => 0 ≤ ((1 : ℝ) * center.x + (0 : ℝ) * center.y + (-8 / 5 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * center.x + (0 : ℝ) * center.y + (12 / 5 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (4 / 5 : ℝ) * center.y + (-12 / 5 : ℝ))
  | 17 => 0 ≤ ((1 : ℝ) * center.x + (0 : ℝ) * center.y + (-12 / 5 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * center.x + (0 : ℝ) * center.y + (3 : ℝ)) ∧ 0 ≤ ((-43 / 500 : ℝ) * center.x + (3 / 5 : ℝ) * center.y + (-996 / 625 : ℝ))
  | 18 => 0 ≤ ((1 : ℝ) * center.x + (0 : ℝ) * center.y + (-1 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * center.x + (0 : ℝ) * center.y + (8 / 5 : ℝ)) ∧ 0 ≤ ((43 / 500 : ℝ) * center.x + (3 / 5 : ℝ) * center.y + (-1211 / 625 : ℝ))
  | 19 => 0 ≤ ((0 : ℝ) * center.x + (1 : ℝ) * center.y + (-87 / 50 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-1 : ℝ) * center.y + (113 / 50 : ℝ)) ∧ 0 ≤ ((13 / 25 : ℝ) * center.x + (0 : ℝ) * center.y + (-39 / 25 : ℝ))
  | 20 => 0 ≤ ((0 : ℝ) * center.x + (1 : ℝ) * center.y + (-113 / 50 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-1 : ℝ) * center.y + (1543 / 500 : ℝ)) ∧ 0 ≤ ((413 / 500 : ℝ) * center.x + (0 : ℝ) * center.y + (-1239 / 500 : ℝ))
  | 21 => 0 ≤ ((0 : ℝ) * center.x + (1 : ℝ) * center.y + (-1 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-1 : ℝ) * center.y + (87 / 50 : ℝ)) ∧ 0 ≤ ((37 / 50 : ℝ) * center.x + (43 / 500 : ℝ) * center.y + (-59241 / 25000 : ℝ))
  | 22 => 0 ≤ ((-1 : ℝ) * center.x + (0 : ℝ) * center.y + (1 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-1 : ℝ) * center.y + (457 / 500 : ℝ))
  | 23 => 0 ≤ ((1 : ℝ) * center.x + (0 : ℝ) * center.y + (-1543 / 500 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (-1 : ℝ) * center.y + (1 : ℝ))
  | 24 => 0 ≤ ((-1 : ℝ) * center.x + (0 : ℝ) * center.y + (1 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (1 : ℝ) * center.y + (-1543 / 500 : ℝ))
  | 25 => 0 ≤ ((1 : ℝ) * center.x + (0 : ℝ) * center.y + (-3 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * center.x + (1 : ℝ) * center.y + (-1543 / 500 : ℝ))
...
lemma initial02_hit_boundary (square : PlacedSquare) (fits : square.Fits 4)
    (index : Fin 28) (membership : initial02Region index square.center) :
    (∃ index, square.Contains (initial02Points index)) ∨ Hole square.center := by
  fin_cases index
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial02Points 0) (initial02Points 6) (initial02Points 4)
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap]) (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap]) with first_inside | second_inside | third_inside
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial02Points 0) (initial02Points 10) (initial02Points 6)
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial02Points 1) (initial02Points 4) (initial02Points 7)
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial02Points 1) (initial02Points 7) (initial02Points 11)
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial02Points 2) (initial02Points 5) (initial02Points 8)
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial02Points 2) (initial02Points 8) (initial02Points 12)
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial02Points 3) (initial02Points 9) (initial02Points 5)
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial02Points 3) (initial02Points 13) (initial02Points 9)
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial02Points 4) (initial02Points 6) (initial02Points 7)
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    rcases square.contains_triangleVertex_of_cross_nonnegative
      (initial02Points 5) (initial02Points 9) (initial02Points 8)
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_0])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_1])
      (by norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap, Point.orientedArea]; linarith only [bound_2])
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    ...
    ·
      refine ⟨6, ?_⟩
      norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨7, ?_⟩
      norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    have pair := Stromquist.TenPoints.contains_short_pair (square := square)
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    ...
    ·
      refine ⟨0, ?_⟩
      apply (square.swap_contains_iff (initial02Points 0)).1
      norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨2, ?_⟩
      apply (square.swap_contains_iff (initial02Points 2)).1
      norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    ...
    ·
      refine ⟨12, ?_⟩
      apply (square.swap_contains_iff (initial02Points 12)).1
      norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    ...
    ·
      refine ⟨10, ?_⟩
      apply (square.swap_contains_iff (initial02Points 10)).1
      norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨0, ?_⟩
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    ...
    ·
      refine ⟨8, ?_⟩
      apply (square.reflectY_contains_iff 4 (initial02Points 8)).1
      norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨9, ?_⟩
      apply (square.reflectY_contains_iff 4 (initial02Points 9)).1
      norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    ...
    ·
      refine ⟨13, ?_⟩
      apply (square.reflectY_contains_iff 4 (initial02Points 13)).1
      norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    ...
    ·
      refine ⟨12, ?_⟩
      apply (square.reflectY_contains_iff 4 (initial02Points 12)).1
      norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨8, ?_⟩
  ...
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    ...
    ·
      refine ⟨1, ?_⟩
      apply (square.reflectX_contains_iff 4 (initial02Points 1)).1
      apply ((square.reflectX 4).swap_contains_iff ((initial02Points 1).reflectX 4)).1
      norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨3, ?_⟩
      apply (square.reflectX_contains_iff 4 (initial02Points 3)).1
      apply ((square.reflectX 4).swap_contains_iff ((initial02Points 3).reflectX 4)).1
      norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    have pair := ((square.reflectX 4).swap).contains_bottomSharpPair (left := (113 / 50 : ℝ))
    ...
    ·
      refine ⟨13, ?_⟩
      apply (square.reflectX_contains_iff 4 (initial02Points 13)).1
      apply ((square.reflectX 4).swap_contains_iff ((initial02Points 13).reflectX 4)).1
      norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at second_inside ⊢
      exact second_inside
  · rcases membership with ⟨bound_0, bound_1, bound_2⟩
    apply Or.inl
    ...
    ·
      refine ⟨11, ?_⟩
      apply (square.reflectX_contains_iff 4 (initial02Points 11)).1
      apply ((square.reflectX 4).swap_contains_iff ((initial02Points 11).reflectX 4)).1
      norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at first_inside ⊢
      exact first_inside
    ·
      refine ⟨1, ?_⟩
  ...
  · rcases membership with ⟨bound_0, bound_1⟩
    ...
    have inside := square.contains_cornerPoint (targetX := (1 : ℝ))
      ...
      (by linarith only [bound_1])
    refine ⟨10, ?_⟩
    norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at inside ⊢
    exact inside
  · rcases membership with ⟨bound_0, bound_1⟩
    apply Or.inl
  ...
  · rcases membership with ⟨bound_0, bound_1⟩
    ...
    refine ⟨13, ?_⟩
    apply (square.reflectX_contains_iff 4 (initial02Points 13)).1
    apply ((square.reflectX 4).reflectY_contains_iff 4 ((initial02Points 13).reflectX 4)).1
    norm_num [initial02Points, initialPoints, cornerAlternative, choicePattern, Point.reflectX, Point.reflectY, Point.swap] at inside ⊢
    exact inside
...
set_option maxHeartbeats 4000000 in
theorem initial02_cover : ∀ square : PlacedSquare, square.Fits 4 → (∃ index, square.Contains (initial02Points index)) ∨ Hole square.center := by
  intro square fits
  ...
  ·
    ...
    ·
      ...
      ·
        ...
        ·
          apply initial02_hit_boundary square fits 0
        ...
        ·
          ...
          by_cases branch_4 : 0 ≤ ((0 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-4 / 5 : ℝ))
          ·
            apply initial02_hit_boundary square fits 8
          ...
          ·
            have branch_4_negative : 0 < ((0 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (4 / 5 : ℝ)) := by linarith only [branch_4]
            apply initial02_hit_boundary square fits 10
      ...
      ·
        ...
        by_cases branch_5 : 0 ≤ ((413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-413 / 500 : ℝ))
        ·
          by_cases branch_6 : 0 ≤ ((-43 / 500 : ℝ) * square.center.x + (3 / 5 : ℝ) * square.center.y + (-289 / 625 : ℝ))
          ·
            apply initial02_hit_boundary square fits 1
            change 0 ≤ ((413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-413 / 500 : ℝ)) ∧ 0 ≤ ((-43 / 500 : ℝ) * square.center.x + (3 / 5 : ℝ) * square.center.y + (-289 / 625 : ℝ)) ∧ 0 ≤ ((-37 / 50 : ℝ) * square.center.x + (-3 / 5 : ℝ) * square.center.y + (223 / 125 : ℝ))
            refine ⟨?_ , ?_ , ?_ ⟩
            ·
              exact branch_5
            ·
          ...
          ·
            have branch_6_negative : 0 < ((43 / 500 : ℝ) * square.center.x + (-3 / 5 : ℝ) * square.center.y + (289 / 625 : ℝ)) := by linarith only [branch_6]
            by_cases branch_7 : 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-8 / 5 : ℝ))
            ·
              apply initial02_hit_boundary square fits 10
              change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-8 / 5 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (12 / 5 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (4 / 5 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ...
              ·
                ...
                have weighted_0 := mul_pos (by norm_num : 0 < (43 / 625 : ℝ)) branch_2_negative
                have weighted_1 := mul_pos (by norm_num : 0 < (74 / 125 : ℝ)) branch_6_negative
                have weighted_2 := mul_pos (by norm_num : 0 < (1239 / 2500 : ℝ)) negative
                have identity : (43 / 625 : ℝ) * ((-37 / 50 : ℝ) * square.center.x + (-3 / 5 : ℝ) * square.center.y + (223 / 125 : ℝ)) + (74 / 125 : ℝ) * ((43 / 500 : ℝ) * square.center.x + (-3 / 5 : ℝ) * square.center.y + (289 / 625 : ℝ)) + (1239 / 2500 : ℝ) * ((0 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-4 / 5 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, weighted_2, identity]
            ·
              have branch_7_negative : 0 < ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (8 / 5 : ℝ)) := by linarith only [branch_7]
              apply initial02_hit_boundary square fits 12
        ...
        ·
          have branch_5_negative : 0 < ((-413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (413 / 500 : ℝ)) := by linarith only [branch_5]
          by_cases branch_8 : 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-457 / 500 : ℝ))
          ·
            apply initial02_hit_boundary square fits 15
          ...
          ·
            have branch_8_negative : 0 < ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (457 / 500 : ℝ)) := by linarith only [branch_8]
            apply initial02_hit_boundary square fits 22
    ...
    ·
      ...
      ·
        ...
        ·
          apply initial02_hit_boundary square fits 2
        ...
        ·
          ...
          by_cases branch_11 : 0 ≤ ((0 : ℝ) * square.center.x + (343 / 500 : ℝ) * square.center.y + (-343 / 500 : ℝ))
          ·
            apply initial02_hit_boundary square fits 8
            change 0 ≤ ((37 / 50 : ℝ) * square.center.x + (-2 / 5 : ℝ) * square.center.y + (-98 / 125 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-4 / 5 : ℝ)) ∧ 0 ≤ ((-37 / 50 : ℝ) * square.center.x + (-2 / 5 : ℝ) * square.center.y + (272 / 125 : ℝ))
            refine ⟨?_ , ?_ , ?_ ⟩
            ...
            ·
              by_contra! failed
              have negative : 0 < ((0 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (4 / 5 : ℝ)) := by linarith only [failed]
              have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (4 / 5 : ℝ)) branch_11
          ...
          ·
            have branch_11_negative : 0 < ((0 : ℝ) * square.center.x + (-343 / 500 : ℝ) * square.center.y + (343 / 500 : ℝ)) := by linarith only [branch_11]
            apply initial02_hit_boundary square fits 10
            change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-8 / 5 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (12 / 5 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (4 / 5 : ℝ))
            refine ⟨?_ , ?_ , ?_ ⟩
            ·
            ...
            ·
              by_contra! failed
              have negative : 0 < ((0 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-4 / 5 : ℝ)) := by linarith only [failed]
              have weighted_0 := mul_pos (by norm_num : 0 < (4 / 5 : ℝ)) branch_11_negative
              have weighted_1 := mul_pos (by norm_num : 0 < (343 / 500 : ℝ)) negative
              have identity : (4 / 5 : ℝ) * ((0 : ℝ) * square.center.x + (-343 / 500 : ℝ) * square.center.y + (343 / 500 : ℝ)) + (343 / 500 : ℝ) * ((0 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-4 / 5 : ℝ)) = (0 : ℝ) := by
                ring
              nlinarith only [weighted_0, weighted_1, identity]
      ·
        ...
        by_cases branch_12 : 0 ≤ ((0 : ℝ) * square.center.x + (343 / 500 : ℝ) * square.center.y + (-343 / 500 : ℝ))
        ·
          by_cases branch_13 : 0 ≤ ((-37 / 50 : ℝ) * square.center.x + (-43 / 500 : ℝ) * square.center.y + (59241 / 25000 : ℝ))
          ·
            apply initial02_hit_boundary square fits 3
            change 0 ≤ ((37 / 50 : ℝ) * square.center.x + (-3 / 5 : ℝ) * square.center.y + (-147 / 125 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (343 / 500 : ℝ) * square.center.y + (-343 / 500 : ℝ)) ∧ 0 ≤ ((-37 / 50 : ℝ) * square.center.x + (-43 / 500 : ℝ) * square.center.y + (59241 / 25000 : ℝ))
            refine ⟨?_ , ?_ , ?_ ⟩
            ·
            ...
            ·
              exact branch_13
          ·
            have branch_13_negative : 0 < ((37 / 50 : ℝ) * square.center.x + (43 / 500 : ℝ) * square.center.y + (-59241 / 25000 : ℝ)) := by linarith only [branch_13]
            apply initial02_hit_boundary square fits 21
            change 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-1 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (87 / 50 : ℝ)) ∧ 0 ≤ ((37 / 50 : ℝ) * square.center.x + (43 / 500 : ℝ) * square.center.y + (-59241 / 25000 : ℝ))
            refine ⟨?_ , ?_ , ?_ ⟩
            ·
              by_contra! failed
        ...
        ·
          have branch_12_negative : 0 < ((0 : ℝ) * square.center.x + (-343 / 500 : ℝ) * square.center.y + (343 / 500 : ℝ)) := by linarith only [branch_12]
          by_cases branch_14 : 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (1543 / 500 : ℝ))
          ·
            by_cases branch_15 : 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (12 / 5 : ℝ))
            ·
              apply initial02_hit_boundary square fits 10
              change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-8 / 5 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (12 / 5 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (4 / 5 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ...
              ·
                by_contra! failed
                have negative : 0 < ((0 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-4 / 5 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_pos (by norm_num : 0 < (4 / 5 : ℝ)) branch_12_negative
                have weighted_1 := mul_pos (by norm_num : 0 < (343 / 500 : ℝ)) negative
                have identity : (4 / 5 : ℝ) * ((0 : ℝ) * square.center.x + (-343 / 500 : ℝ) * square.center.y + (343 / 500 : ℝ)) + (343 / 500 : ℝ) * ((0 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-4 / 5 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, identity]
            ·
              have branch_15_negative : 0 < ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-12 / 5 : ℝ)) := by linarith only [branch_15]
              apply initial02_hit_boundary square fits 11
              change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-12 / 5 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (1543 / 500 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-343 / 500 : ℝ) * square.center.y + (343 / 500 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ·
          ...
          ·
            have branch_14_negative : 0 < ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-1543 / 500 : ℝ)) := by linarith only [branch_14]
            apply initial02_hit_boundary square fits 23
  ...
  ·
    ...
    ·
      ...
      ·
        ...
        ·
          ...
          ·
            apply initial02_hit_boundary square fits 4
          ...
          ·
            ...
            by_cases branch_20 : 0 ≤ ((0 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (12 / 5 : ℝ))
            ·
              apply initial02_hit_boundary square fits 9
            ...
            ·
              have branch_20_negative : 0 < ((0 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-12 / 5 : ℝ)) := by linarith only [branch_20]
              apply initial02_hit_boundary square fits 16
        ...
        ·
          ...
          by_cases branch_21 : 0 ≤ ((413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-413 / 500 : ℝ))
          ·
            by_cases branch_22 : 0 ≤ ((-43 / 500 : ℝ) * square.center.x + (-3 / 5 : ℝ) * square.center.y + (1211 / 625 : ℝ))
            ·
              apply initial02_hit_boundary square fits 5
              change 0 ≤ ((-37 / 50 : ℝ) * square.center.x + (3 / 5 : ℝ) * square.center.y + (-77 / 125 : ℝ)) ∧ 0 ≤ ((-43 / 500 : ℝ) * square.center.x + (-3 / 5 : ℝ) * square.center.y + (1211 / 625 : ℝ)) ∧ 0 ≤ ((413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-413 / 500 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ·
              ...
              ·
                exact branch_21
            ·
              have branch_22_negative : 0 < ((43 / 500 : ℝ) * square.center.x + (3 / 5 : ℝ) * square.center.y + (-1211 / 625 : ℝ)) := by linarith only [branch_22]
              by_cases branch_23 : 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-8 / 5 : ℝ))
              ·
                apply initial02_hit_boundary square fits 16
                change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-8 / 5 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (12 / 5 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-12 / 5 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ...
                ·
                  ...
                  have weighted_0 := mul_pos (by norm_num : 0 < (43 / 625 : ℝ)) branch_18_negative
                  have weighted_1 := mul_pos (by norm_num : 0 < (74 / 125 : ℝ)) branch_22_negative
                  have weighted_2 := mul_pos (by norm_num : 0 < (1239 / 2500 : ℝ)) negative
                  have identity : (43 / 625 : ℝ) * ((-37 / 50 : ℝ) * square.center.x + (3 / 5 : ℝ) * square.center.y + (-77 / 125 : ℝ)) + (74 / 125 : ℝ) * ((43 / 500 : ℝ) * square.center.x + (3 / 5 : ℝ) * square.center.y + (-1211 / 625 : ℝ)) + (1239 / 2500 : ℝ) * ((0 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (12 / 5 : ℝ)) = (0 : ℝ) := by
                    ring
                  nlinarith only [weighted_0, weighted_1, weighted_2, identity]
              ·
                have branch_23_negative : 0 < ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (8 / 5 : ℝ)) := by linarith only [branch_23]
                apply initial02_hit_boundary square fits 18
          ...
          ·
            have branch_21_negative : 0 < ((-413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (413 / 500 : ℝ)) := by linarith only [branch_21]
            by_cases branch_24 : 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (1543 / 500 : ℝ))
            ·
              apply initial02_hit_boundary square fits 14
            ...
            ·
              have branch_24_negative : 0 < ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-1543 / 500 : ℝ)) := by linarith only [branch_24]
              apply initial02_hit_boundary square fits 24
      ...
      ·
        ...
        ·
          ...
          ·
            apply initial02_hit_boundary square fits 6
          ...
          ·
            ...
            by_cases branch_27 : 0 ≤ ((0 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (12 / 5 : ℝ))
            ·
              apply initial02_hit_boundary square fits 9
              change 0 ≤ ((-37 / 50 : ℝ) * square.center.x + (2 / 5 : ℝ) * square.center.y + (72 / 125 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (12 / 5 : ℝ)) ∧ 0 ≤ ((37 / 50 : ℝ) * square.center.x + (2 / 5 : ℝ) * square.center.y + (-298 / 125 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ...
              ·
                ...
                nlinarith only [weighted_0, weighted_1, weighted_2, identity]
            ·
              have branch_27_negative : 0 < ((0 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-12 / 5 : ℝ)) := by linarith only [branch_27]
              apply initial02_hit_boundary square fits 16
              change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-8 / 5 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (12 / 5 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-12 / 5 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ·
        ...
        ·
          ...
          by_cases branch_28 : 0 ≤ ((-413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (1239 / 500 : ℝ))
          ·
            by_cases branch_29 : 0 ≤ ((43 / 500 : ℝ) * square.center.x + (-3 / 5 : ℝ) * square.center.y + (996 / 625 : ℝ))
            ·
              apply initial02_hit_boundary square fits 7
              change 0 ≤ ((-413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (1239 / 500 : ℝ)) ∧ 0 ≤ ((43 / 500 : ℝ) * square.center.x + (-3 / 5 : ℝ) * square.center.y + (996 / 625 : ℝ)) ∧ 0 ≤ ((37 / 50 : ℝ) * square.center.x + (3 / 5 : ℝ) * square.center.y + (-447 / 125 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ·
                exact branch_28
              ·
            ...
            ·
              have branch_29_negative : 0 < ((-43 / 500 : ℝ) * square.center.x + (3 / 5 : ℝ) * square.center.y + (-996 / 625 : ℝ)) := by linarith only [branch_29]
              by_cases branch_30 : 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (12 / 5 : ℝ))
              ·
                apply initial02_hit_boundary square fits 16
                change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-8 / 5 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (12 / 5 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-12 / 5 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ...
                ·
                  by_contra! failed
                  have negative : 0 < ((0 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (12 / 5 : ℝ)) := by linarith only [failed]
                  have weighted_0 := mul_pos (by norm_num : 0 < (43 / 625 : ℝ)) branch_25_negative
                  have weighted_1 := mul_pos (by norm_num : 0 < (74 / 125 : ℝ)) branch_29_negative
                  have weighted_2 := mul_pos (by norm_num : 0 < (1239 / 2500 : ℝ)) negative
                  have identity : (43 / 625 : ℝ) * ((37 / 50 : ℝ) * square.center.x + (3 / 5 : ℝ) * square.center.y + (-447 / 125 : ℝ)) + (74 / 125 : ℝ) * ((-43 / 500 : ℝ) * square.center.x + (3 / 5 : ℝ) * square.center.y + (-996 / 625 : ℝ)) + (1239 / 2500 : ℝ) * ((0 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (12 / 5 : ℝ)) = (0 : ℝ) := by
                    ring
                  nlinarith only [weighted_0, weighted_1, weighted_2, identity]
              ·
                have branch_30_negative : 0 < ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-12 / 5 : ℝ)) := by linarith only [branch_30]
                apply initial02_hit_boundary square fits 17
                change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-12 / 5 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 : ℝ)) ∧ 0 ≤ ((-43 / 500 : ℝ) * square.center.x + (3 / 5 : ℝ) * square.center.y + (-996 / 625 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ·
          ...
          ·
            have branch_28_negative : 0 < ((413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-1239 / 500 : ℝ)) := by linarith only [branch_28]
            by_cases branch_31 : 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (1543 / 500 : ℝ))
            ·
              apply initial02_hit_boundary square fits 20
              change 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-113 / 50 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (1543 / 500 : ℝ)) ∧ 0 ≤ ((413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-1239 / 500 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ·
                exact branch_16
              ·
            ...
            ·
              have branch_31_negative : 0 < ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-1543 / 500 : ℝ)) := by linarith only [branch_31]
              apply initial02_hit_boundary square fits 25
    ...
    ·
      ...
      ·
        by_cases branch_33 : 0 ≤ ((413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-413 / 500 : ℝ))
        ·
          apply initial02_hit_boundary square fits 26
        ...
        ·
          have branch_33_negative : 0 < ((-413 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (413 / 500 : ℝ)) := by linarith only [branch_33]
          apply initial02_hit_boundary square fits 13
          ...
          ·
            ...
            have weighted_0 := mul_pos (by norm_num : 0 < (13 / 25 : ℝ)) branch_33_negative
            have weighted_1 := mul_pos (by norm_num : 0 < (413 / 500 : ℝ)) negative
      ...
      ·
        ...
        ·
          apply initial02_hit_boundary square fits 27
        ...
        ·
          ...
          apply initial02_hit_boundary square fits 19
