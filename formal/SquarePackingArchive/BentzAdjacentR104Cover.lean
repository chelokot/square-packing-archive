import SquarePackingArchive.BentzAdjacentR104Geometry

namespace SquarePackingArchive.BentzThirteen

set_option maxHeartbeats 4000000 in
theorem adjacentR104_unavoidable : ∀ square : PlacedSquare, square.Fits 4 → adjacentR104Outcome square := by
  intro square fits
  ...
  ·
    ...
    ·
      ...
      ·
        ...
        ·
          by_cases branch_4 : 0 ≤ ((453 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-453 / 500 : ℝ))
          ·
            apply adjacentR104_hit_boundary square fits 3
            ...
            ·
              ...
              have weighted_1 := mul_nonneg (by norm_num : 0 ≤ (1517 / 5000 : ℝ)) branch_3
              have weighted_2 := mul_pos (by norm_num : 0 < (1591 / 50000 : ℝ)) negative
              have identity : (453 / 1000 : ℝ) * ((0 : ℝ) * square.center.x + (-37 / 100 : ℝ) * square.center.y + (37 / 100 : ℝ)) + (1517 / 5000 : ℝ) * ((-43 / 500 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-371 / 1000 : ℝ)) + (1591 / 50000 : ℝ) * ((41 / 50 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-173 / 100 : ℝ)) = (0 : ℝ) := by
                ring
              nlinarith only [weighted_0, weighted_1, weighted_2, identity]
            ·
              exact branch_4
          ·
            have branch_4_negative : 0 < ((-453 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (453 / 500 : ℝ)) := by linarith only [branch_4]
            by_cases branch_5 : 0 ≤ ((43 / 500 : ℝ) * square.center.x + (43 / 500 : ℝ) * square.center.y + (-41151 / 250000 : ℝ))
            ·
              apply adjacentR104_hit_boundary square fits 1
              ...
              ·
                ...
                have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (5889 / 50000 : ℝ)) branch_3
                have weighted_1 := mul_pos (by norm_num : 0 < (1591 / 50000 : ℝ)) branch_4_negative
                have weighted_2 := mul_pos (by norm_num : 0 < (453 / 1000 : ℝ)) negative
                have identity : (5889 / 50000 : ℝ) * ((-43 / 500 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-371 / 1000 : ℝ)) + (1591 / 50000 : ℝ) * ((-453 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (453 / 500 : ℝ)) + (453 / 1000 : ℝ) * ((43 / 500 : ℝ) * square.center.x + (-13 / 100 : ℝ) * square.center.y + (1641 / 50000 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, weighted_2, identity]
              ·
                by_contra! failed
              ...
              ·
                exact branch_5
            ·
              have branch_5_negative : 0 < ((-43 / 500 : ℝ) * square.center.x + (-43 / 500 : ℝ) * square.center.y + (41151 / 250000 : ℝ)) := by linarith only [branch_5]
              by_cases branch_6 : 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (457 / 500 : ℝ))
              ·
                apply adjacentR104_hit_boundary square fits 27
                ...
                ·
                  ...
                  nlinarith only [weighted_0, weighted_1, identity]
              ·
                have branch_6_negative : 0 < ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-457 / 500 : ℝ)) := by linarith only [branch_6]
                apply adjacentR104_hit_boundary square fits 33
        ...
        ·
          ...
          ·
            by_cases branch_8 : 0 ≤ ((-41 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (173 / 100 : ℝ))
            ·
              by_cases branch_9 : 0 ≤ ((77 / 500 : ℝ) * square.center.x + (87 / 100 : ℝ) * square.center.y + (-47459 / 50000 : ℝ))
              ·
                apply adjacentR104_hit_boundary square fits 2
                ...
                ·
                  ...
                  have weighted_1 := mul_nonneg (by norm_num : 0 ≤ (111 / 1250 : ℝ)) branch_8
              ...
              ·
                have branch_9_negative : 0 < ((-77 / 500 : ℝ) * square.center.x + (-87 / 100 : ℝ) * square.center.y + (47459 / 50000 : ℝ)) := by linarith only [branch_9]
                by_cases branch_10 : 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-87 / 50 : ℝ))
                ·
                  apply adjacentR104_hit_boundary square fits 32
                ...
                ·
                  ...
                  apply adjacentR104_hit_boundary square fits 31
            ...
            ·
              have branch_8_negative : 0 < ((41 / 50 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-173 / 100 : ℝ)) := by linarith only [branch_8]
              by_cases branch_11 : 0 ≤ ((41 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (-31 / 20 : ℝ))
              ·
                apply adjacentR104_hit_boundary square fits 32
                change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-87 / 50 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (5 / 2 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-19 / 25 : ℝ) * square.center.y + (19 / 25 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ·
                  ...
                  have weighted_1 := mul_nonneg (by norm_num : 0 ≤ (1 : ℝ)) branch_11
                  have weighted_2 := mul_pos (by norm_num : 0 < (41 / 50 : ℝ)) negative
                  have identity : (1 / 2 : ℝ) * ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (0 : ℝ)) + (1 : ℝ) * ((41 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (-31 / 20 : ℝ)) + (41 / 50 : ℝ) * ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (87 / 50 : ℝ)) = (-77 / 625 : ℝ) := by
                    ring
                  have constant_negative := (by norm_num : 0 < (77 / 625 : ℝ))
                ...
                ·
                  ...
                  nlinarith only [weighted_0, weighted_1, identity]
              ·
                have branch_11_negative : 0 < ((-41 / 50 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (31 / 20 : ℝ)) := by linarith only [branch_11]
                ...
                ·
                  ...
                  ·
                    by_cases branch_14 : 0 ≤ ((77 / 500 : ℝ) * square.center.x + (87 / 100 : ℝ) * square.center.y + (-47459 / 50000 : ℝ))
                    ·
                      apply adjacentR104_hit_boundary square fits 2
                      change 0 ≤ ((77 / 500 : ℝ) * square.center.x + (87 / 100 : ℝ) * square.center.y + (-47459 / 50000 : ℝ)) ∧ 0 ≤ ((-6 / 25 : ℝ) * square.center.x + (-37 / 100 : ℝ) * square.center.y + (73 / 100 : ℝ)) ∧ 0 ≤ ((43 / 500 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (371 / 1000 : ℝ))
                      refine ⟨?_ , ?_ , ?_ ⟩
                      ...
                      ·
                        exact branch_3_negative.le
                    ·
                      have branch_14_negative : 0 < ((-77 / 500 : ℝ) * square.center.x + (-87 / 100 : ℝ) * square.center.y + (47459 / 50000 : ℝ)) := by linarith only [branch_14]
                      apply adjacentR104_hit_boundary square fits 31
                      change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-1 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (187 / 100 : ℝ)) ∧ 0 ≤ ((-77 / 500 : ℝ) * square.center.x + (-87 / 100 : ℝ) * square.center.y + (47459 / 50000 : ℝ))
                      refine ⟨?_ , ?_ , ?_ ⟩
                      ·
                ...
                ·
                  ...
                  by_cases branch_15 : 0 ≤ ((-6 / 25 : ℝ) * square.center.x + (63 / 100 : ℝ) * square.center.y + (-3 / 100 : ℝ))
                  ·
                    apply adjacentR104_hit_boundary square fits 8
                    ...
                    ·
                      ...
                      nlinarith only [weighted_0, weighted_1, identity]
                  ·
                    have branch_15_negative : 0 < ((6 / 25 : ℝ) * square.center.x + (-63 / 100 : ℝ) * square.center.y + (3 / 100 : ℝ)) := by linarith only [branch_15]
                    apply adjacentR104_hit_boundary square fits 32
                    change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-87 / 50 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (5 / 2 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-19 / 25 : ℝ) * square.center.y + (19 / 25 : ℝ))
                    refine ⟨?_ , ?_ , ?_ ⟩
                    ·
                      ...
                      have weighted_1 := mul_pos (by norm_num : 0 < (37 / 100 : ℝ)) branch_15_negative
          ...
          ·
            ...
            by_cases branch_16 : 0 ≤ ((43 / 500 : ℝ) * square.center.x + (-13 / 100 : ℝ) * square.center.y + (1641 / 50000 : ℝ))
            ·
              by_cases branch_17 : 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (457 / 500 : ℝ))
              ·
                apply adjacentR104_hit_boundary square fits 27
                change 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (457 / 500 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (1 : ℝ))
                refine ⟨?_ , ?_ ⟩
                ...
                ·
                  ...
                  nlinarith only [weighted_0, weighted_1, identity]
              ·
                have branch_17_negative : 0 < ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-457 / 500 : ℝ)) := by linarith only [branch_17]
                apply adjacentR104_hit_boundary square fits 33
                change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-457 / 500 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (113 / 100 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-27 / 125 : ℝ) * square.center.y + (27 / 125 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ·
                ...
                ·
                  ...
                  nlinarith only [weighted_0, weighted_1, identity]
            ·
              have branch_16_negative : 0 < ((-43 / 500 : ℝ) * square.center.x + (13 / 100 : ℝ) * square.center.y + (-1641 / 50000 : ℝ)) := by linarith only [branch_16]
              by_cases branch_18 : 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (457 / 500 : ℝ))
              ·
                apply adjacentR104_hit_boundary square fits 27
                change 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (457 / 500 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (1 : ℝ))
                refine ⟨?_ , ?_ ⟩
                ...
                ·
                  ...
                  nlinarith only [weighted_0, weighted_1, identity]
              ·
                have branch_18_negative : 0 < ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-457 / 500 : ℝ)) := by linarith only [branch_18]
                apply adjacentR104_hit_boundary square fits 33
                change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-457 / 500 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (113 / 100 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-27 / 125 : ℝ) * square.center.y + (27 / 125 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ·
      ...
      ·
        ...
        ·
          apply adjacentR104_hit_boundary square fits 34
        ...
        ·
          ...
          apply adjacentR104_hit_boundary square fits 28
    ...
    ·
      ...
      by_cases branch_20 : 0 ≤ ((41 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (-73 / 100 : ℝ))
      ·
        by_cases branch_21 : 0 ≤ ((-41 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (51 / 20 : ℝ))
        ·
          apply adjacentR104_hit_boundary square fits 10
          ...
          ·
            exact branch_20
        ·
          have branch_21_negative : 0 < ((41 / 50 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-51 / 20 : ℝ)) := by linarith only [branch_21]
          by_cases branch_22 : 0 ≤ ((41 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (-31 / 20 : ℝ))
          ·
            by_cases branch_23 : 0 ≤ ((-41 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (123 / 50 : ℝ))
            ·
              apply adjacentR104_hit_boundary square fits 20
              ...
              ·
                exact branch_22
            ·
              have branch_23_negative : 0 < ((41 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-123 / 50 : ℝ)) := by linarith only [branch_23]
              apply adjacentR104_hit_boundary square fits 43
          ...
          ·
            have branch_22_negative : 0 < ((-41 / 50 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (31 / 20 : ℝ)) := by linarith only [branch_22]
            apply adjacentR104_hit_boundary square fits 21
      ...
      ·
        have branch_20_negative : 0 < ((-41 / 50 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (73 / 100 : ℝ)) := by linarith only [branch_20]
        by_cases branch_24 : 0 ≤ ((-41 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (173 / 100 : ℝ))
        ·
          ...
          ·
            ...
            ·
              ...
              have weighted_1 := mul_pos (by norm_num : 0 < (1591 / 50000 : ℝ)) branch_20_negative
              have weighted_2 := mul_pos (by norm_num : 0 < (1517 / 5000 : ℝ)) negative
          ...
          ·
            ...
            by_cases branch_26 : 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (113 / 100 : ℝ))
            ·
              apply adjacentR104_hit_boundary square fits 35
              ...
              ·
                ...
                nlinarith only [weighted_0, weighted_1, identity]
            ·
              have branch_26_negative : 0 < ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-113 / 100 : ℝ)) := by linarith only [branch_26]
              apply adjacentR104_hit_boundary square fits 36
              ...
              ·
                ...
                have weighted_0 := mul_pos (by norm_num : 0 < (69 / 100 : ℝ)) branch_25_negative
                have weighted_1 := mul_pos (by norm_num : 0 < (453 / 500 : ℝ)) negative
                ...
                nlinarith only [weighted_0, weighted_1, identity]
        ·
          have branch_24_negative : 0 < ((41 / 50 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-173 / 100 : ℝ)) := by linarith only [branch_24]
          apply adjacentR104_hit_boundary square fits 9
  ...
  ·
    ...
    ·
      by_cases branch_28 : 0 ≤ ((453 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-453 / 500 : ℝ))
      ·
        by_cases branch_29 : 0 ≤ ((-2 / 5 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (89 / 50 : ℝ))
        ·
          by_cases branch_30 : 0 ≤ ((-27 / 50 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-37 / 100 : ℝ))
          ·
            apply adjacentR104_hit_boundary square fits 13
            change 0 ≤ ((-27 / 50 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-37 / 100 : ℝ)) ∧ 0 ≤ ((-2 / 5 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (89 / 50 : ℝ)) ∧ 0 ≤ ((47 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-47 / 50 : ℝ))
            refine ⟨?_ , ?_ , ?_ ⟩
            ·
              exact branch_30
            ·
            ...
            ·
              by_contra! failed
              have negative : 0 < ((-47 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (47 / 50 : ℝ)) := by linarith only [failed]
              have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (47 / 50 : ℝ)) branch_28
              have weighted_1 := mul_pos (by norm_num : 0 < (453 / 500 : ℝ)) negative
              have identity : (47 / 50 : ℝ) * ((453 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-453 / 500 : ℝ)) + (453 / 500 : ℝ) * ((-47 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (47 / 50 : ℝ)) = (0 : ℝ) := by
                ring
              nlinarith only [weighted_0, weighted_1, identity]
          ·
            have branch_30_negative : 0 < ((27 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (37 / 100 : ℝ)) := by linarith only [branch_30]
            apply adjacentR104_hit_boundary square fits 14
            ...
            ·
              ...
              have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (7 / 100 : ℝ)) branch_27
              have weighted_1 := mul_nonneg (by norm_num : 0 ≤ (73 / 200 : ℝ)) branch_29
              have weighted_2 := mul_pos (by norm_num : 0 < (73 / 200 : ℝ)) negative
              have identity : (7 / 100 : ℝ) * ((-73 / 100 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (219 / 200 : ℝ)) + (73 / 200 : ℝ) * ((-2 / 5 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (89 / 50 : ℝ)) + (73 / 200 : ℝ) * ((27 / 50 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-199 / 100 : ℝ)) = (0 : ℝ) := by
                ring
              nlinarith only [weighted_0, weighted_1, weighted_2, identity]
            ·
              exact branch_30_negative.le
        ·
          have branch_29_negative : 0 < ((2 / 5 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-89 / 50 : ℝ)) := by linarith only [branch_29]
          by_cases branch_31 : 0 ≤ ((33 / 100 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (21 / 20 : ℝ))
          ·
            apply adjacentR104_hit_boundary square fits 15
            change 0 ≤ ((-73 / 100 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (219 / 200 : ℝ)) ∧ 0 ≤ ((33 / 100 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (21 / 20 : ℝ)) ∧ 0 ≤ ((2 / 5 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-89 / 50 : ℝ))
            refine ⟨?_ , ?_ , ?_ ⟩
            ·
              exact branch_27
            ·
          ...
          ·
            have branch_31_negative : 0 < ((-33 / 100 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-21 / 20 : ℝ)) := by linarith only [branch_31]
            by_cases branch_32 : 0 ≤ ((9 / 100 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (141 / 100 : ℝ))
            ·
              apply adjacentR104_hit_boundary square fits 18
              change 0 ≤ ((9 / 100 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (141 / 100 : ℝ)) ∧ 0 ≤ ((6 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-6 / 25 : ℝ)) ∧ 0 ≤ ((-33 / 100 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-21 / 20 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ·
                exact branch_32
              ·
                by_contra! failed
                have negative : 0 < ((-6 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (6 / 25 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (6 / 25 : ℝ)) branch_28
                have weighted_1 := mul_pos (by norm_num : 0 < (453 / 500 : ℝ)) negative
                have identity : (6 / 25 : ℝ) * ((453 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-453 / 500 : ℝ)) + (453 / 500 : ℝ) * ((-6 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (6 / 25 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, identity]
              ·
                exact branch_31_negative.le
            ·
              have branch_32_negative : 0 < ((-9 / 100 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-141 / 100 : ℝ)) := by linarith only [branch_32]
              apply adjacentR104_hit_boundary square fits 41
      ...
      ·
        have branch_28_negative : 0 < ((-453 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (453 / 500 : ℝ)) := by linarith only [branch_28]
        by_cases branch_33 : 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (69 / 25 : ℝ))
        ·
          by_cases branch_34 : 0 ≤ ((7 / 50 : ℝ) * square.center.x + (6 / 25 : ℝ) * square.center.y + (-721 / 1250 : ℝ))
          ·
            by_cases branch_35 : 0 ≤ ((4 / 5 : ℝ) * square.center.x + (-6 / 25 : ℝ) * square.center.y + (-86 / 625 : ℝ))
            ·
              apply adjacentR104_hit_boundary square fits 12
              change 0 ≤ ((-47 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (47 / 50 : ℝ)) ∧ 0 ≤ ((4 / 5 : ℝ) * square.center.x + (-6 / 25 : ℝ) * square.center.y + (-86 / 625 : ℝ)) ∧ 0 ≤ ((7 / 50 : ℝ) * square.center.x + (6 / 25 : ℝ) * square.center.y + (-721 / 1250 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ·
                by_contra! failed
                have negative : 0 < ((47 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-47 / 50 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_pos (by norm_num : 0 < (47 / 50 : ℝ)) branch_28_negative
                have weighted_1 := mul_pos (by norm_num : 0 < (453 / 500 : ℝ)) negative
                have identity : (47 / 50 : ℝ) * ((-453 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (453 / 500 : ℝ)) + (453 / 500 : ℝ) * ((47 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-47 / 50 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, identity]
              ...
              ·
                exact branch_34
            ·
              have branch_35_negative : 0 < ((-4 / 5 : ℝ) * square.center.x + (6 / 25 : ℝ) * square.center.y + (86 / 625 : ℝ)) := by linarith only [branch_35]
              apply adjacentR104_hit_boundary square fits 38
              change 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-49 / 25 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (69 / 25 : ℝ)) ∧ 0 ≤ ((-4 / 5 : ℝ) * square.center.x + (6 / 25 : ℝ) * square.center.y + (86 / 625 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ·
                by_contra! failed
                have negative : 0 < ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (49 / 25 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (4 / 5 : ℝ)) branch_34
                have weighted_1 := mul_pos (by norm_num : 0 < (7 / 50 : ℝ)) branch_35_negative
                have weighted_2 := mul_pos (by norm_num : 0 < (141 / 625 : ℝ)) negative
                have identity : (4 / 5 : ℝ) * ((7 / 50 : ℝ) * square.center.x + (6 / 25 : ℝ) * square.center.y + (-721 / 1250 : ℝ)) + (7 / 50 : ℝ) * ((-4 / 5 : ℝ) * square.center.x + (6 / 25 : ℝ) * square.center.y + (86 / 625 : ℝ)) + (141 / 625 : ℝ) * ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (49 / 25 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, weighted_2, identity]
              ·
                exact branch_33
          ...
          ·
            have branch_34_negative : 0 < ((-7 / 50 : ℝ) * square.center.x + (-6 / 25 : ℝ) * square.center.y + (721 / 1250 : ℝ)) := by linarith only [branch_34]
            by_cases branch_36 : 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (49 / 25 : ℝ))
            ·
              apply adjacentR104_hit_boundary square fits 37
            ...
            ·
              have branch_36_negative : 0 < ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-49 / 25 : ℝ)) := by linarith only [branch_36]
              apply adjacentR104_hit_boundary square fits 38
              change 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-49 / 25 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (69 / 25 : ℝ)) ∧ 0 ≤ ((-4 / 5 : ℝ) * square.center.x + (6 / 25 : ℝ) * square.center.y + (86 / 625 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ·
              ...
              ·
                by_contra! failed
                have negative : 0 < ((4 / 5 : ℝ) * square.center.x + (-6 / 25 : ℝ) * square.center.y + (-86 / 625 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_pos (by norm_num : 0 < (4 / 5 : ℝ)) branch_34_negative
                have weighted_1 := mul_pos (by norm_num : 0 < (141 / 625 : ℝ)) branch_36_negative
                have weighted_2 := mul_pos (by norm_num : 0 < (7 / 50 : ℝ)) negative
                have identity : (4 / 5 : ℝ) * ((-7 / 50 : ℝ) * square.center.x + (-6 / 25 : ℝ) * square.center.y + (721 / 1250 : ℝ)) + (141 / 625 : ℝ) * ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-49 / 25 : ℝ)) + (7 / 50 : ℝ) * ((4 / 5 : ℝ) * square.center.x + (-6 / 25 : ℝ) * square.center.y + (-86 / 625 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, weighted_2, identity]
        ·
          have branch_33_negative : 0 < ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-69 / 25 : ℝ)) := by linarith only [branch_33]
          by_cases branch_37 : 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-3 : ℝ))
          ·
            apply adjacentR104_hit_boundary square fits 29
            ...
            ·
              exact branch_37
          ·
            have branch_37_negative : 0 < ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (3 : ℝ)) := by linarith only [branch_37]
            apply adjacentR104_hit_boundary square fits 39
            change 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-69 / 25 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (3 : ℝ)) ∧ 0 ≤ ((-6 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (6 / 25 : ℝ))
            refine ⟨?_ , ?_ , ?_ ⟩
            ·
            ...
            ·
              by_contra! failed
              have negative : 0 < ((6 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-6 / 25 : ℝ)) := by linarith only [failed]
              have weighted_0 := mul_pos (by norm_num : 0 < (6 / 25 : ℝ)) branch_28_negative
              have weighted_1 := mul_pos (by norm_num : 0 < (453 / 500 : ℝ)) negative
              have identity : (6 / 25 : ℝ) * ((-453 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (453 / 500 : ℝ)) + (453 / 500 : ℝ) * ((6 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-6 / 25 : ℝ)) = (0 : ℝ) := by
                ring
              nlinarith only [weighted_0, weighted_1, identity]
    ·
      ...
      by_cases branch_38 : 0 ≤ ((-17 / 25 : ℝ) * square.center.x + (3 / 10 : ℝ) * square.center.y + (407 / 500 : ℝ))
      ·
        by_cases branch_39 : 0 ≤ ((-7 / 50 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-839 / 500 : ℝ))
        ·
          by_cases branch_40 : 0 ≤ ((-59 / 100 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (3357 / 1000 : ℝ))
          ·
            apply adjacentR104_hit_boundary square fits 16
          ...
          ·
            have branch_40_negative : 0 < ((59 / 100 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-3357 / 1000 : ℝ)) := by linarith only [branch_40]
            by_cases branch_41 : 0 ≤ ((-1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (23 / 20 : ℝ))
            ·
              by_cases branch_42 : 0 ≤ ((-9 / 100 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (2607 / 1000 : ℝ))
              ·
                apply adjacentR104_hit_boundary square fits 19
                ...
                ·
                  exact branch_42
              ·
                have branch_42_negative : 0 < ((9 / 100 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-2607 / 1000 : ℝ)) := by linarith only [branch_42]
                apply adjacentR104_hit_boundary square fits 40
            ...
            ·
              have branch_41_negative : 0 < ((1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-23 / 20 : ℝ)) := by linarith only [branch_41]
              by_cases branch_43 : 0 ≤ ((0 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (21 / 10 : ℝ))
              ·
                apply adjacentR104_hit_boundary square fits 25
                ...
                ·
                  ...
                  have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (151 / 500 : ℝ)) branch_38
                  have weighted_1 := mul_nonneg (by norm_num : 0 ≤ (163 / 500 : ℝ)) branch_39
              ...
              ·
                have branch_43_negative : 0 < ((0 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-21 / 10 : ℝ)) := by linarith only [branch_43]
                apply adjacentR104_hit_boundary square fits 42
                ...
                ·
                  ...
                  have weighted_1 := mul_nonneg (by norm_num : 0 ≤ (1 : ℝ)) branch_38
        ...
        ·
          have branch_39_negative : 0 < ((7 / 50 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (839 / 500 : ℝ)) := by linarith only [branch_39]
          by_cases branch_44 : 0 ≤ ((-27 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (199 / 100 : ℝ))
          ·
            apply adjacentR104_hit_boundary square fits 14
            change 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-91 / 50 : ℝ)) ∧ 0 ≤ ((-27 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (199 / 100 : ℝ)) ∧ 0 ≤ ((27 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (37 / 100 : ℝ))
            refine ⟨?_ , ?_ , ?_ ⟩
            ...
            ·
              ...
              have weighted_1 := mul_pos (by norm_num : 0 < (73 / 200 : ℝ)) branch_39_negative
              ...
              nlinarith only [weighted_0, weighted_1, weighted_2, identity]
          ·
            have branch_44_negative : 0 < ((27 / 50 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-199 / 100 : ℝ)) := by linarith only [branch_44]
            apply adjacentR104_hit_boundary square fits 17
      ...
      ·
        have branch_38_negative : 0 < ((17 / 25 : ℝ) * square.center.x + (-3 / 10 : ℝ) * square.center.y + (-407 / 500 : ℝ)) := by linarith only [branch_38]
        by_cases branch_45 : 0 ≤ ((-17 / 25 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (1657 / 500 : ℝ))
        ·
          apply adjacentR104_hit_boundary square fits 22
        ...
        ·
          have branch_45_negative : 0 < ((17 / 25 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-1657 / 500 : ℝ)) := by linarith only [branch_45]
          by_cases branch_46 : 0 ≤ ((0 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (7 / 4 : ℝ))
          ·
            by_cases branch_47 : 0 ≤ ((-41 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (123 / 50 : ℝ))
            ·
              apply adjacentR104_hit_boundary square fits 23
              ...
              ·
                ...
                have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (17 / 25 : ℝ)) branch_47
                have weighted_1 := mul_pos (by norm_num : 0 < (41 / 50 : ℝ)) negative
            ...
            ·
              have branch_47_negative : 0 < ((41 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-123 / 50 : ℝ)) := by linarith only [branch_47]
              apply adjacentR104_hit_boundary square fits 44
              ...
              ·
                by_contra! failed
                have negative : 0 < ((-17 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (51 / 25 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_pos (by norm_num : 0 < (17 / 25 : ℝ)) branch_47_negative
                have weighted_1 := mul_pos (by norm_num : 0 < (41 / 50 : ℝ)) negative
                have identity : (17 / 25 : ℝ) * ((41 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-123 / 50 : ℝ)) + (41 / 50 : ℝ) * ((-17 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (51 / 25 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, identity]
          ·
            have branch_46_negative : 0 < ((0 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-7 / 4 : ℝ)) := by linarith only [branch_46]
            by_cases branch_48 : 0 ≤ ((1 / 2 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (3 / 5 : ℝ))
            ·
              by_cases branch_49 : 0 ≤ ((-17 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (51 / 25 : ℝ))
              ·
                apply adjacentR104_hit_boundary square fits 24
                ...
                ·
                  ...
                  have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (1 / 2 : ℝ)) branch_49
                ...
                ·
                  exact branch_48
              ·
                have branch_49_negative : 0 < ((17 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-51 / 25 : ℝ)) := by linarith only [branch_49]
                by_cases branch_50 : 0 ≤ ((0 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (21 / 10 : ℝ))
                ·
                  apply adjacentR104_hit_boundary square fits 45
                  ...
                  ·
                    ...
                    have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (1 : ℝ)) branch_50
                    have weighted_1 := mul_pos (by norm_num : 0 < (7 / 10 : ℝ)) negative
                  ...
                  ·
                    by_contra! failed
                    have negative : 0 < ((-1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 / 2 : ℝ)) := by linarith only [failed]
                    have weighted_0 := mul_pos (by norm_num : 0 < (1 / 2 : ℝ)) branch_49_negative
                    have weighted_1 := mul_pos (by norm_num : 0 < (17 / 25 : ℝ)) negative
                    have identity : (1 / 2 : ℝ) * ((17 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-51 / 25 : ℝ)) + (17 / 25 : ℝ) * ((-1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 / 2 : ℝ)) = (0 : ℝ) := by
                      ring
                    nlinarith only [weighted_0, weighted_1, identity]
                ·
                  ...
                  apply adjacentR104_hit_boundary square fits 30
                  ...
                  ·
                    ...
                    nlinarith only [weighted_0, weighted_1, identity]
            ·
              have branch_48_negative : 0 < ((-1 / 2 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-3 / 5 : ℝ)) := by linarith only [branch_48]
              by_cases branch_51 : 0 ≤ ((0 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (21 / 10 : ℝ))
              ·
                apply adjacentR104_hit_boundary square fits 25
                change 0 ≤ ((-1 / 2 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-3 / 5 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (21 / 10 : ℝ)) ∧ 0 ≤ ((1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-23 / 20 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ...
                ·
                  ...
                  have weighted_0 := mul_pos (by norm_num : 0 < (7 / 20 : ℝ)) branch_38_negative
                  have weighted_1 := mul_pos (by norm_num : 0 < (3 / 20 : ℝ)) branch_45_negative
                  have weighted_2 := mul_pos (by norm_num : 0 < (17 / 25 : ℝ)) negative
                  ...
                  nlinarith only [weighted_0, weighted_1, weighted_2, identity]
              ·
                have branch_51_negative : 0 < ((0 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-21 / 10 : ℝ)) := by linarith only [branch_51]
                by_cases branch_52 : 0 ≤ ((-1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 / 2 : ℝ))
                ·
                  apply adjacentR104_hit_boundary square fits 42
                  change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-23 / 10 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-21 / 10 : ℝ))
                  refine ⟨?_ , ?_ , ?_ ⟩
                  ·
                    by_contra! failed
                    have negative : 0 < ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (23 / 10 : ℝ)) := by linarith only [failed]
                    have weighted_0 := mul_pos (by norm_num : 0 < (7 / 10 : ℝ)) branch_38_negative
                    have weighted_1 := mul_pos (by norm_num : 0 < (3 / 10 : ℝ)) branch_45_negative
                    have weighted_2 := mul_pos (by norm_num : 0 < (17 / 25 : ℝ)) negative
                  ...
                  ·
                    by_contra! failed
                    have negative : 0 < ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-3 : ℝ)) := by linarith only [failed]
                    have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (1 : ℝ)) branch_52
                    have weighted_1 := mul_pos (by norm_num : 0 < (1 / 2 : ℝ)) negative
                ...
                ·
                  have branch_52_negative : 0 < ((1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-3 / 2 : ℝ)) := by linarith only [branch_52]
                  apply adjacentR104_hit_boundary square fits 30
                  change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-3 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-3 : ℝ))
                  refine ⟨?_ , ?_ ⟩
                  ·
                    by_contra! failed
                    have negative : 0 < ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 : ℝ)) := by linarith only [failed]
                    have weighted_0 := mul_pos (by norm_num : 0 < (1 : ℝ)) branch_52_negative
                    have weighted_1 := mul_pos (by norm_num : 0 < (1 / 2 : ℝ)) negative
                    have identity : (1 : ℝ) * ((1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-3 / 2 : ℝ)) + (1 / 2 : ℝ) * ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 : ℝ)) = (0 : ℝ) := by
                      ring
                    nlinarith only [weighted_0, weighted_1, identity]
