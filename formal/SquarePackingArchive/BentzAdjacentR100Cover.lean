import SquarePackingArchive.BentzAdjacentR100Geometry

namespace SquarePackingArchive.BentzThirteen

set_option maxHeartbeats 4000000 in
theorem adjacentR100_unavoidable : ∀ square : PlacedSquare, square.Fits 4 → adjacentR100Outcome square := by
  intro square fits
  ...
  ·
    ...
    ·
      ...
      ·
        ...
        ·
          ...
          ·
            ...
            ·
              ...
              ·
                apply adjacentR100_hit_boundary square fits 0
              ...
              ·
                ...
                ·
                  apply adjacentR100_hit_boundary square fits 24
                ...
                ·
                  ...
                  apply adjacentR100_hit_boundary square fits 30
          ...
          ·
            ...
            ·
              apply adjacentR100_hit_boundary square fits 2
            ...
            ·
              ...
              ·
                ...
                ·
                  apply adjacentR100_hit_boundary square fits 29
                ...
                ·
                  ...
                  apply adjacentR100_hit_boundary square fits 28
        ...
        ·
          ...
          ·
            ...
            ·
              apply adjacentR100_hit_boundary square fits 6
      ...
      ·
        ...
        ·
          apply adjacentR100_hit_boundary square fits 31
        ...
        ·
          ...
          apply adjacentR100_hit_boundary square fits 25
    ...
    ·
      ...
      ·
        ...
        ·
          apply adjacentR100_hit_boundary square fits 9
        ...
        ·
          ...
          ·
            ...
            ·
              apply adjacentR100_hit_boundary square fits 18
            ...
            ·
              ...
              apply adjacentR100_hit_boundary square fits 39
          ...
          ·
            ...
            apply adjacentR100_hit_boundary square fits 19
      ...
      ·
        ...
        ·
          ...
          ·
            ...
            ·
              ...
              ·
                apply adjacentR100_hit_boundary square fits 3
              ...
              ·
                ...
                apply adjacentR100_hit_boundary square fits 32
            ...
            ·
              ...
              ·
                ...
                apply adjacentR100_hit_boundary square fits 33
        ...
        ·
          ...
          apply adjacentR100_hit_boundary square fits 8
  ...
  ·
    ...
    ·
      by_cases branch_28 : 0 ≤ ((-17 / 25 : ℝ) * square.center.x + (3 / 10 : ℝ) * square.center.y + (407 / 500 : ℝ))
      ·
        by_cases branch_29 : 0 ≤ ((-7 / 50 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-839 / 500 : ℝ))
        ·
          by_cases branch_30 : 0 ≤ ((-59 / 100 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (3357 / 1000 : ℝ))
          ·
            apply adjacentR100_hit_boundary square fits 13
            ...
            ·
              exact branch_27
          ·
            have branch_30_negative : 0 < ((59 / 100 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-3357 / 1000 : ℝ)) := by linarith only [branch_30]
            by_cases branch_31 : 0 ≤ ((-1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (23 / 20 : ℝ))
            ·
              by_cases branch_32 : 0 ≤ ((-9 / 100 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (2607 / 1000 : ℝ))
              ·
                apply adjacentR100_hit_boundary square fits 17
                ...
                ·
                  exact branch_32
              ·
                have branch_32_negative : 0 < ((9 / 100 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-2607 / 1000 : ℝ)) := by linarith only [branch_32]
                apply adjacentR100_hit_boundary square fits 36
                ...
                ·
                  ...
                  have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (1 : ℝ)) branch_31
            ...
            ·
              have branch_31_negative : 0 < ((1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-23 / 20 : ℝ)) := by linarith only [branch_31]
              by_cases branch_33 : 0 ≤ ((0 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (21 / 10 : ℝ))
              ·
                apply adjacentR100_hit_boundary square fits 23
                ...
                ·
                  ...
                  have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (151 / 500 : ℝ)) branch_28
                  have weighted_1 := mul_nonneg (by norm_num : 0 ≤ (163 / 500 : ℝ)) branch_29
              ...
              ·
                have branch_33_negative : 0 < ((0 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-21 / 10 : ℝ)) := by linarith only [branch_33]
                apply adjacentR100_hit_boundary square fits 38
                ...
                ·
                  by_contra! failed
                  have negative : 0 < ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (23 / 10 : ℝ)) := by linarith only [failed]
                  have weighted_0 := mul_pos (by norm_num : 0 < (1 : ℝ)) branch_31_negative
                  have weighted_1 := mul_pos (by norm_num : 0 < (1 / 2 : ℝ)) negative
                  have identity : (1 : ℝ) * ((1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-23 / 20 : ℝ)) + (1 / 2 : ℝ) * ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (23 / 10 : ℝ)) = (0 : ℝ) := by
                    ring
                  nlinarith only [weighted_0, weighted_1, identity]
                ·
                  ...
                  have weighted_1 := mul_nonneg (by norm_num : 0 ≤ (1 : ℝ)) branch_28
        ...
        ·
          have branch_29_negative : 0 < ((7 / 50 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (839 / 500 : ℝ)) := by linarith only [branch_29]
          by_cases branch_34 : 0 ≤ ((-27 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (199 / 100 : ℝ))
          ·
            apply adjacentR100_hit_boundary square fits 12
            ...
            ·
              ...
              have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (181 / 500 : ℝ)) branch_27
              have weighted_1 := mul_pos (by norm_num : 0 < (73 / 200 : ℝ)) branch_29_negative
          ...
          ·
            ...
            apply adjacentR100_hit_boundary square fits 16
      ...
      ·
        have branch_28_negative : 0 < ((17 / 25 : ℝ) * square.center.x + (-3 / 10 : ℝ) * square.center.y + (-407 / 500 : ℝ)) := by linarith only [branch_28]
        by_cases branch_35 : 0 ≤ ((-17 / 25 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (1657 / 500 : ℝ))
        ·
          apply adjacentR100_hit_boundary square fits 20
        ...
        ·
          have branch_35_negative : 0 < ((17 / 25 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-1657 / 500 : ℝ)) := by linarith only [branch_35]
          by_cases branch_36 : 0 ≤ ((0 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (7 / 4 : ℝ))
          ·
            by_cases branch_37 : 0 ≤ ((-41 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (123 / 50 : ℝ))
            ·
              apply adjacentR100_hit_boundary square fits 21
              ...
              ·
                ...
                have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (17 / 25 : ℝ)) branch_37
                have weighted_1 := mul_pos (by norm_num : 0 < (41 / 50 : ℝ)) negative
            ...
            ·
              have branch_37_negative : 0 < ((41 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-123 / 50 : ℝ)) := by linarith only [branch_37]
              apply adjacentR100_hit_boundary square fits 40
              ...
              ·
                ...
                have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (1 : ℝ)) branch_36
              ...
              ·
                by_contra! failed
                have negative : 0 < ((-17 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (51 / 25 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_pos (by norm_num : 0 < (17 / 25 : ℝ)) branch_37_negative
                have weighted_1 := mul_pos (by norm_num : 0 < (41 / 50 : ℝ)) negative
                have identity : (17 / 25 : ℝ) * ((41 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-123 / 50 : ℝ)) + (41 / 50 : ℝ) * ((-17 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (51 / 25 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, identity]
          ·
            have branch_36_negative : 0 < ((0 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-7 / 4 : ℝ)) := by linarith only [branch_36]
            by_cases branch_38 : 0 ≤ ((1 / 2 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (3 / 5 : ℝ))
            ·
              by_cases branch_39 : 0 ≤ ((-17 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (51 / 25 : ℝ))
              ·
                apply adjacentR100_hit_boundary square fits 22
                ...
                ·
                  ...
                  have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (1 / 2 : ℝ)) branch_39
                ...
                ·
                  exact branch_38
              ·
                have branch_39_negative : 0 < ((17 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-51 / 25 : ℝ)) := by linarith only [branch_39]
                by_cases branch_40 : 0 ≤ ((0 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (21 / 10 : ℝ))
                ·
                  apply adjacentR100_hit_boundary square fits 41
                  ...
                  ·
                    ...
                    nlinarith only [weighted_0, weighted_1, identity]
                ·
                  have branch_40_negative : 0 < ((0 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-21 / 10 : ℝ)) := by linarith only [branch_40]
                  apply adjacentR100_hit_boundary square fits 27
                  change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-3 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-3 : ℝ))
                  refine ⟨?_ , ?_ ⟩
                  ·
                    by_contra! failed
                    have negative : 0 < ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 : ℝ)) := by linarith only [failed]
                    have weighted_0 := mul_pos (by norm_num : 0 < (1 : ℝ)) branch_39_negative
                    have weighted_1 := mul_pos (by norm_num : 0 < (17 / 25 : ℝ)) negative
                  ...
                  ·
                    ...
                    nlinarith only [weighted_0, weighted_1, identity]
            ·
              have branch_38_negative : 0 < ((-1 / 2 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-3 / 5 : ℝ)) := by linarith only [branch_38]
              by_cases branch_41 : 0 ≤ ((0 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (21 / 10 : ℝ))
              ·
                apply adjacentR100_hit_boundary square fits 23
                change 0 ≤ ((-1 / 2 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-3 / 5 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (21 / 10 : ℝ)) ∧ 0 ≤ ((1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-23 / 20 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ...
                ·
                  ...
                  have weighted_0 := mul_pos (by norm_num : 0 < (7 / 20 : ℝ)) branch_28_negative
                  have weighted_1 := mul_pos (by norm_num : 0 < (3 / 20 : ℝ)) branch_35_negative
                  have weighted_2 := mul_pos (by norm_num : 0 < (17 / 25 : ℝ)) negative
                  ...
                  nlinarith only [weighted_0, weighted_1, weighted_2, identity]
              ·
                have branch_41_negative : 0 < ((0 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-21 / 10 : ℝ)) := by linarith only [branch_41]
                by_cases branch_42 : 0 ≤ ((-1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 / 2 : ℝ))
                ·
                  apply adjacentR100_hit_boundary square fits 38
                  change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-23 / 10 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-21 / 10 : ℝ))
                  refine ⟨?_ , ?_ , ?_ ⟩
                  ·
                    by_contra! failed
                    have negative : 0 < ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (23 / 10 : ℝ)) := by linarith only [failed]
                    have weighted_0 := mul_pos (by norm_num : 0 < (7 / 10 : ℝ)) branch_28_negative
                    have weighted_1 := mul_pos (by norm_num : 0 < (3 / 10 : ℝ)) branch_35_negative
                    have weighted_2 := mul_pos (by norm_num : 0 < (17 / 25 : ℝ)) negative
                ...
                ·
                  have branch_42_negative : 0 < ((1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-3 / 2 : ℝ)) := by linarith only [branch_42]
                  apply adjacentR100_hit_boundary square fits 27
                  change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-3 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-3 : ℝ))
                  refine ⟨?_ , ?_ ⟩
                  ·
    ...
    ·
      ...
      by_cases branch_43 : 0 ≤ ((-2 / 25 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (13 / 10 : ℝ))
      ·
        by_cases branch_44 : 0 ≤ ((-27 / 50 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-37 / 100 : ℝ))
        ·
          by_cases branch_45 : 0 ≤ ((453 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-453 / 500 : ℝ))
          ·
            apply adjacentR100_hit_boundary square fits 11
            change 0 ≤ ((-27 / 50 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-37 / 100 : ℝ)) ∧ 0 ≤ ((-2 / 25 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (13 / 10 : ℝ)) ∧ 0 ≤ ((31 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-31 / 50 : ℝ))
            refine ⟨?_ , ?_ , ?_ ⟩
            ·
              exact branch_44
            ·
            ...
            ·
              by_contra! failed
              have negative : 0 < ((-31 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (31 / 50 : ℝ)) := by linarith only [failed]
              have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (31 / 50 : ℝ)) branch_45
              have weighted_1 := mul_pos (by norm_num : 0 < (453 / 500 : ℝ)) negative
              have identity : (31 / 50 : ℝ) * ((453 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-453 / 500 : ℝ)) + (453 / 500 : ℝ) * ((-31 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (31 / 50 : ℝ)) = (0 : ℝ) := by
                ring
              nlinarith only [weighted_0, weighted_1, identity]
          ·
            have branch_45_negative : 0 < ((-453 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (453 / 500 : ℝ)) := by linarith only [branch_45]
            by_cases branch_46 : 0 ≤ ((7 / 50 : ℝ) * square.center.x + (6 / 25 : ℝ) * square.center.y + (-721 / 1250 : ℝ))
            ·
              by_cases branch_47 : 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (61 / 25 : ℝ))
              ·
                apply adjacentR100_hit_boundary square fits 34
                change 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-91 / 50 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (61 / 25 : ℝ)) ∧ 0 ≤ ((-31 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (31 / 50 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ·
                  exact branch_0_negative.le
                ·
                ...
                ·
                  by_contra! failed
                  have negative : 0 < ((31 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-31 / 50 : ℝ)) := by linarith only [failed]
                  have weighted_0 := mul_pos (by norm_num : 0 < (31 / 50 : ℝ)) branch_45_negative
                  have weighted_1 := mul_pos (by norm_num : 0 < (453 / 500 : ℝ)) negative
                  have identity : (31 / 50 : ℝ) * ((-453 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (453 / 500 : ℝ)) + (453 / 500 : ℝ) * ((31 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-31 / 50 : ℝ)) = (0 : ℝ) := by
                    ring
                  nlinarith only [weighted_0, weighted_1, identity]
              ·
                have branch_47_negative : 0 < ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-61 / 25 : ℝ)) := by linarith only [branch_47]
                apply adjacentR100_hit_boundary square fits 35
                change 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-61 / 25 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (3 : ℝ)) ∧ 0 ≤ ((-14 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (14 / 25 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ·
                ...
                ·
                  by_contra! failed
                  have negative : 0 < ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-3 : ℝ)) := by linarith only [failed]
                  have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (2 / 25 : ℝ)) container_0
                  have weighted_1 := mul_nonneg (by norm_num : 0 ≤ (1 : ℝ)) branch_43
                  have weighted_2 := mul_pos (by norm_num : 0 < (1 / 2 : ℝ)) negative
                  have identity : (2 / 25 : ℝ) * ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (0 : ℝ)) + (1 : ℝ) * ((-2 / 25 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (13 / 10 : ℝ)) + (1 / 2 : ℝ) * ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-3 : ℝ)) = (-1 / 5 : ℝ) := by
                    ring
                  have constant_negative := (by norm_num : 0 < (1 / 5 : ℝ))
                  nlinarith only [weighted_0, weighted_1, weighted_2, constant_negative, identity]
                ·
                  by_contra! failed
                  have negative : 0 < ((14 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-14 / 25 : ℝ)) := by linarith only [failed]
                  have weighted_0 := mul_pos (by norm_num : 0 < (14 / 25 : ℝ)) branch_45_negative
                  have weighted_1 := mul_pos (by norm_num : 0 < (453 / 500 : ℝ)) negative
                  have identity : (14 / 25 : ℝ) * ((-453 / 500 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (453 / 500 : ℝ)) + (453 / 500 : ℝ) * ((14 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-14 / 25 : ℝ)) = (0 : ℝ) := by
                    ring
                  nlinarith only [weighted_0, weighted_1, identity]
            ·
              have branch_46_negative : 0 < ((-7 / 50 : ℝ) * square.center.x + (-6 / 25 : ℝ) * square.center.y + (721 / 1250 : ℝ)) := by linarith only [branch_46]
              apply adjacentR100_hit_boundary square fits 34
              change 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-91 / 50 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (61 / 25 : ℝ)) ∧ 0 ≤ ((-31 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (31 / 50 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ·
              ...
              ·
                by_contra! failed
                have negative : 0 < ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-61 / 25 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (7 / 50 : ℝ)) container_0
                have weighted_1 := mul_pos (by norm_num : 0 < (1 : ℝ)) branch_46_negative
                have weighted_2 := mul_pos (by norm_num : 0 < (6 / 25 : ℝ)) negative
                have identity : (7 / 50 : ℝ) * ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (0 : ℝ)) + (1 : ℝ) * ((-7 / 50 : ℝ) * square.center.x + (-6 / 25 : ℝ) * square.center.y + (721 / 1250 : ℝ)) + (6 / 25 : ℝ) * ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-61 / 25 : ℝ)) = (-11 / 1250 : ℝ) := by
                  ring
                have constant_negative := (by norm_num : 0 < (11 / 1250 : ℝ))
                nlinarith only [weighted_0, weighted_1, weighted_2, constant_negative, identity]
              ·
                by_contra! failed
                have negative : 0 < ((31 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-31 / 50 : ℝ)) := by linarith only [failed]
                ...
                nlinarith only [weighted_0, weighted_1, identity]
        ·
          have branch_44_negative : 0 < ((27 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (37 / 100 : ℝ)) := by linarith only [branch_44]
          apply adjacentR100_hit_boundary square fits 12
          change 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-91 / 50 : ℝ)) ∧ 0 ≤ ((-27 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (199 / 100 : ℝ)) ∧ 0 ≤ ((27 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (37 / 100 : ℝ))
          refine ⟨?_ , ?_ , ?_ ⟩
          ·
          ...
          ·
            ...
            have weighted_0 := mul_pos (by norm_num : 0 < (23 / 100 : ℝ)) branch_27_negative
            have weighted_1 := mul_nonneg (by norm_num : 0 ≤ (73 / 200 : ℝ)) branch_43
            have weighted_2 := mul_pos (by norm_num : 0 < (73 / 200 : ℝ)) negative
            have identity : (23 / 100 : ℝ) * ((-73 / 100 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (219 / 200 : ℝ)) + (73 / 200 : ℝ) * ((-2 / 25 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (13 / 10 : ℝ)) + (73 / 200 : ℝ) * ((27 / 50 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-199 / 100 : ℝ)) = (0 : ℝ) := by
              ring
            nlinarith only [weighted_0, weighted_1, weighted_2, identity]
          ·
            exact branch_44_negative.le
      ·
        have branch_43_negative : 0 < ((2 / 25 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-13 / 10 : ℝ)) := by linarith only [branch_43]
        by_cases branch_48 : 0 ≤ ((16 / 25 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-107 / 50 : ℝ))
        ·
          by_cases branch_49 : 0 ≤ ((9 / 100 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (141 / 100 : ℝ))
          ·
            apply adjacentR100_hit_boundary square fits 14
            change 0 ≤ ((-73 / 100 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (219 / 200 : ℝ)) ∧ 0 ≤ ((9 / 100 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (141 / 100 : ℝ)) ∧ 0 ≤ ((16 / 25 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-107 / 50 : ℝ))
            refine ⟨?_ , ?_ , ?_ ⟩
            ·
            ...
            ·
              exact branch_48
          ·
            have branch_49_negative : 0 < ((-9 / 100 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-141 / 100 : ℝ)) := by linarith only [branch_49]
            by_cases branch_50 : 0 ≤ ((14 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-14 / 25 : ℝ))
            ·
              apply adjacentR100_hit_boundary square fits 37
              ...
              ·
                ...
                have weighted_1 := mul_pos (by norm_num : 0 < (14 / 25 : ℝ)) negative
                have identity : (1 : ℝ) * ((14 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-14 / 25 : ℝ)) + (14 / 25 : ℝ) * ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (1 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, identity]
              ·
                by_contra! failed
            ...
            ·
              have branch_50_negative : 0 < ((-14 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (14 / 25 : ℝ)) := by linarith only [branch_50]
              apply adjacentR100_hit_boundary square fits 26
              ...
              ·
                by_contra! failed
                have negative : 0 < ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (3 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (9 / 100 : ℝ)) branch_48
                have weighted_1 := mul_pos (by norm_num : 0 < (16 / 25 : ℝ)) branch_49_negative
                have weighted_2 := mul_pos (by norm_num : 0 < (73 / 200 : ℝ)) negative
                have identity : (9 / 100 : ℝ) * ((16 / 25 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-107 / 50 : ℝ)) + (16 / 25 : ℝ) * ((-9 / 100 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-141 / 100 : ℝ)) + (73 / 200 : ℝ) * ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (3 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, weighted_2, identity]
        ·
          have branch_48_negative : 0 < ((-16 / 25 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (107 / 50 : ℝ)) := by linarith only [branch_48]
          by_cases branch_51 : 0 ≤ ((31 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-31 / 50 : ℝ))
          ·
            apply adjacentR100_hit_boundary square fits 15
            change 0 ≤ ((-16 / 25 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (107 / 50 : ℝ)) ∧ 0 ≤ ((14 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-14 / 25 : ℝ)) ∧ 0 ≤ ((2 / 25 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-13 / 10 : ℝ))
            refine ⟨?_ , ?_ , ?_ ⟩
            ·
            ...
            ·
              by_contra! failed
              have negative : 0 < ((-14 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (14 / 25 : ℝ)) := by linarith only [failed]
              have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (14 / 25 : ℝ)) branch_51
              have weighted_1 := mul_pos (by norm_num : 0 < (31 / 50 : ℝ)) negative
              have identity : (14 / 25 : ℝ) * ((31 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-31 / 50 : ℝ)) + (31 / 50 : ℝ) * ((-14 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (14 / 25 : ℝ)) = (0 : ℝ) := by
                ring
              nlinarith only [weighted_0, weighted_1, identity]
            ·
              exact branch_43_negative.le
          ·
            have branch_51_negative : 0 < ((-31 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (31 / 50 : ℝ)) := by linarith only [branch_51]
            by_cases branch_52 : 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-3 : ℝ))
            ·
              apply adjacentR100_hit_boundary square fits 26
              change 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (1 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-3 : ℝ))
              refine ⟨?_ , ?_ ⟩
              ·
                ...
                have weighted_1 := mul_pos (by norm_num : 0 < (31 / 50 : ℝ)) negative
                have identity : (1 : ℝ) * ((-31 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (31 / 50 : ℝ)) + (31 / 50 : ℝ) * ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-1 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, identity]
              ·
                exact branch_52
            ·
              have branch_52_negative : 0 < ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (3 : ℝ)) := by linarith only [branch_52]
              apply adjacentR100_hit_boundary square fits 35
              change 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-61 / 25 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (3 : ℝ)) ∧ 0 ≤ ((-14 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (14 / 25 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ·
                by_contra! failed
                have negative : 0 < ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (61 / 25 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_pos (by norm_num : 0 < (31 / 50 : ℝ)) branch_43_negative
                have weighted_1 := mul_pos (by norm_num : 0 < (2 / 25 : ℝ)) branch_51_negative
                have weighted_2 := mul_pos (by norm_num : 0 < (31 / 100 : ℝ)) negative
                have identity : (31 / 50 : ℝ) * ((2 / 25 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-13 / 10 : ℝ)) + (2 / 25 : ℝ) * ((-31 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (31 / 50 : ℝ)) + (31 / 100 : ℝ) * ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (61 / 25 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, weighted_2, identity]
              ·
              ...
              ·
                by_contra! failed
                have negative : 0 < ((14 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-14 / 25 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_pos (by norm_num : 0 < (14 / 25 : ℝ)) branch_51_negative
                have weighted_1 := mul_pos (by norm_num : 0 < (31 / 50 : ℝ)) negative
                have identity : (14 / 25 : ℝ) * ((-31 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (31 / 50 : ℝ)) + (31 / 50 : ℝ) * ((14 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-14 / 25 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, identity]
