import SquarePackingArchive.BentzAdjacentR107Geometry

namespace SquarePackingArchive.BentzThirteen

set_option maxHeartbeats 4000000 in
theorem adjacentR107_unavoidable : ∀ square : PlacedSquare, square.Fits 4 → adjacentR107Outcome square := by
  intro square fits
  ...
  ·
    ...
    ·
      ...
      ·
        ...
        ·
          ...
          ·
            apply adjacentR107_hit_boundary square fits 0
          ...
          ·
            ...
            ·
              apply adjacentR107_hit_boundary square fits 1
            ...
            ·
              ...
              ·
                ...
                ·
                  apply adjacentR107_hit_boundary square fits 25
                ...
                ·
                  ...
                  apply adjacentR107_hit_boundary square fits 31
        ...
        ·
          ...
          ·
            apply adjacentR107_hit_boundary square fits 2
          ...
          ·
            ...
            ·
              ...
              ·
                apply adjacentR107_hit_boundary square fits 30
              ...
              ·
                ...
                apply adjacentR107_hit_boundary square fits 29
      ...
      ·
        ...
        ·
          ...
          ·
            ...
            ·
              apply adjacentR107_hit_boundary square fits 7
        ...
        ·
          ...
          ·
            apply adjacentR107_hit_boundary square fits 32
          ...
          ·
            ...
            apply adjacentR107_hit_boundary square fits 27
    ...
    ·
      ...
      ·
        ...
        ·
          apply adjacentR107_hit_boundary square fits 10
        ...
        ·
          ...
          ·
            ...
            ·
              apply adjacentR107_hit_boundary square fits 19
            ...
            ·
              ...
              apply adjacentR107_hit_boundary square fits 40
          ...
          ·
            ...
            apply adjacentR107_hit_boundary square fits 20
      ...
      ·
        ...
        ·
          ...
          ·
            apply adjacentR107_hit_boundary square fits 3
          ...
          ·
            ...
            ·
              apply adjacentR107_hit_boundary square fits 4
            ...
            ·
              ...
              ·
                apply adjacentR107_hit_boundary square fits 33
              ...
              ·
                ...
                apply adjacentR107_hit_boundary square fits 34
        ...
        ·
          ...
          apply adjacentR107_hit_boundary square fits 9
  ...
  ·
    ...
    ·
      by_cases branch_30 : 0 ≤ ((-17 / 25 : ℝ) * square.center.x + (3 / 10 : ℝ) * square.center.y + (407 / 500 : ℝ))
      ·
        by_cases branch_31 : 0 ≤ ((-7 / 50 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-839 / 500 : ℝ))
        ·
          by_cases branch_32 : 0 ≤ ((-59 / 100 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (3357 / 1000 : ℝ))
          ·
            apply adjacentR107_hit_boundary square fits 14
            ...
            ·
              exact branch_29
          ·
            have branch_32_negative : 0 < ((59 / 100 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-3357 / 1000 : ℝ)) := by linarith only [branch_32]
            by_cases branch_33 : 0 ≤ ((-1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (23 / 20 : ℝ))
            ·
              by_cases branch_34 : 0 ≤ ((-9 / 100 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (2607 / 1000 : ℝ))
              ·
                apply adjacentR107_hit_boundary square fits 18
                ...
                ·
                  exact branch_34
              ·
                have branch_34_negative : 0 < ((9 / 100 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-2607 / 1000 : ℝ)) := by linarith only [branch_34]
                apply adjacentR107_hit_boundary square fits 37
            ...
            ·
              have branch_33_negative : 0 < ((1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-23 / 20 : ℝ)) := by linarith only [branch_33]
              by_cases branch_35 : 0 ≤ ((0 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (21 / 10 : ℝ))
              ·
                apply adjacentR107_hit_boundary square fits 24
                ...
                ·
                  ...
                  have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (151 / 500 : ℝ)) branch_30
                  have weighted_1 := mul_nonneg (by norm_num : 0 ≤ (163 / 500 : ℝ)) branch_31
              ...
              ·
                have branch_35_negative : 0 < ((0 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-21 / 10 : ℝ)) := by linarith only [branch_35]
                apply adjacentR107_hit_boundary square fits 39
        ...
        ·
          have branch_31_negative : 0 < ((7 / 50 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (839 / 500 : ℝ)) := by linarith only [branch_31]
          by_cases branch_36 : 0 ≤ ((-27 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (199 / 100 : ℝ))
          ·
            apply adjacentR107_hit_boundary square fits 12
            ...
            ·
              ...
              have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (181 / 500 : ℝ)) branch_29
              have weighted_1 := mul_pos (by norm_num : 0 < (73 / 200 : ℝ)) branch_31_negative
              ...
              nlinarith only [weighted_0, weighted_1, weighted_2, identity]
          ·
            have branch_36_negative : 0 < ((27 / 50 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-199 / 100 : ℝ)) := by linarith only [branch_36]
            apply adjacentR107_hit_boundary square fits 16
      ...
      ·
        have branch_30_negative : 0 < ((17 / 25 : ℝ) * square.center.x + (-3 / 10 : ℝ) * square.center.y + (-407 / 500 : ℝ)) := by linarith only [branch_30]
        by_cases branch_37 : 0 ≤ ((-17 / 25 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (1657 / 500 : ℝ))
        ·
          apply adjacentR107_hit_boundary square fits 21
        ...
        ·
          have branch_37_negative : 0 < ((17 / 25 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-1657 / 500 : ℝ)) := by linarith only [branch_37]
          by_cases branch_38 : 0 ≤ ((0 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (7 / 4 : ℝ))
          ·
            by_cases branch_39 : 0 ≤ ((-41 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (123 / 50 : ℝ))
            ·
              apply adjacentR107_hit_boundary square fits 22
              ...
              ·
                ...
                have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (17 / 25 : ℝ)) branch_39
                have weighted_1 := mul_pos (by norm_num : 0 < (41 / 50 : ℝ)) negative
            ...
            ·
              have branch_39_negative : 0 < ((41 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-123 / 50 : ℝ)) := by linarith only [branch_39]
              apply adjacentR107_hit_boundary square fits 41
              ...
              ·
                by_contra! failed
                have negative : 0 < ((-17 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (51 / 25 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_pos (by norm_num : 0 < (17 / 25 : ℝ)) branch_39_negative
                have weighted_1 := mul_pos (by norm_num : 0 < (41 / 50 : ℝ)) negative
                have identity : (17 / 25 : ℝ) * ((41 / 50 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-123 / 50 : ℝ)) + (41 / 50 : ℝ) * ((-17 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (51 / 25 : ℝ)) = (0 : ℝ) := by
                  ring
                nlinarith only [weighted_0, weighted_1, identity]
          ·
            have branch_38_negative : 0 < ((0 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-7 / 4 : ℝ)) := by linarith only [branch_38]
            by_cases branch_40 : 0 ≤ ((1 / 2 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (3 / 5 : ℝ))
            ·
              by_cases branch_41 : 0 ≤ ((-17 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (51 / 25 : ℝ))
              ·
                apply adjacentR107_hit_boundary square fits 23
                ...
                ·
                  ...
                  have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (1 / 2 : ℝ)) branch_41
                ...
                ·
                  exact branch_40
              ·
                have branch_41_negative : 0 < ((17 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-51 / 25 : ℝ)) := by linarith only [branch_41]
                by_cases branch_42 : 0 ≤ ((0 : ℝ) * square.center.x + (-7 / 10 : ℝ) * square.center.y + (21 / 10 : ℝ))
                ·
                  apply adjacentR107_hit_boundary square fits 42
                  ...
                  ·
                    by_contra! failed
                    have negative : 0 < ((-1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 / 2 : ℝ)) := by linarith only [failed]
                    have weighted_0 := mul_pos (by norm_num : 0 < (1 / 2 : ℝ)) branch_41_negative
                    have weighted_1 := mul_pos (by norm_num : 0 < (17 / 25 : ℝ)) negative
                    have identity : (1 / 2 : ℝ) * ((17 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-51 / 25 : ℝ)) + (17 / 25 : ℝ) * ((-1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 / 2 : ℝ)) = (0 : ℝ) := by
                      ring
                    nlinarith only [weighted_0, weighted_1, identity]
                ·
                  ...
                  apply adjacentR107_hit_boundary square fits 28
                  ...
                  ·
                    ...
                    nlinarith only [weighted_0, weighted_1, identity]
            ·
              have branch_40_negative : 0 < ((-1 / 2 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-3 / 5 : ℝ)) := by linarith only [branch_40]
              ...
              ·
                ...
                ·
                  ...
                  have weighted_0 := mul_pos (by norm_num : 0 < (7 / 20 : ℝ)) branch_30_negative
                  have weighted_1 := mul_pos (by norm_num : 0 < (3 / 20 : ℝ)) branch_37_negative
                  have weighted_2 := mul_pos (by norm_num : 0 < (17 / 25 : ℝ)) negative
              ...
              ·
                ...
                by_cases branch_44 : 0 ≤ ((-1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 / 2 : ℝ))
                ·
                  apply adjacentR107_hit_boundary square fits 39
                  change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-23 / 10 : ℝ)) ∧ 0 ≤ ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (3 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-21 / 10 : ℝ))
                  refine ⟨?_ , ?_ , ?_ ⟩
                  ·
                    by_contra! failed
                    have negative : 0 < ((-1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (23 / 10 : ℝ)) := by linarith only [failed]
                    have weighted_0 := mul_pos (by norm_num : 0 < (7 / 10 : ℝ)) branch_30_negative
                    have weighted_1 := mul_pos (by norm_num : 0 < (3 / 10 : ℝ)) branch_37_negative
                    have weighted_2 := mul_pos (by norm_num : 0 < (17 / 25 : ℝ)) negative
                ...
                ·
                  have branch_44_negative : 0 < ((1 / 2 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-3 / 2 : ℝ)) := by linarith only [branch_44]
                  apply adjacentR107_hit_boundary square fits 28
                  change 0 ≤ ((1 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-3 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-3 : ℝ))
                  refine ⟨?_ , ?_ ⟩
                  ·
                  ...
                  ·
                    by_contra! failed
                    have negative : 0 < ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (3 : ℝ)) := by linarith only [failed]
                    have weighted_0 := mul_pos (by norm_num : 0 < (1 : ℝ)) branch_43_negative
                    have weighted_1 := mul_pos (by norm_num : 0 < (7 / 10 : ℝ)) negative
                    have identity : (1 : ℝ) * ((0 : ℝ) * square.center.x + (7 / 10 : ℝ) * square.center.y + (-21 / 10 : ℝ)) + (7 / 10 : ℝ) * ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (3 : ℝ)) = (0 : ℝ) := by
                      ring
                    nlinarith only [weighted_0, weighted_1, identity]
    ·
      ...
      by_cases branch_45 : 0 ≤ ((-7 / 50 : ℝ) * square.center.x + (4 / 5 : ℝ) * square.center.y + (-839 / 500 : ℝ))
      ·
        by_cases branch_46 : 0 ≤ ((1 / 4 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (117 / 100 : ℝ))
        ·
          by_cases branch_47 : 0 ≤ ((-12 / 25 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (19 / 10 : ℝ))
          ·
            by_cases branch_48 : 0 ≤ ((22 / 25 : ℝ) * square.center.x + (-6 / 25 : ℝ) * square.center.y + (-124 / 625 : ℝ))
            ·
              apply adjacentR107_hit_boundary square fits 13
              ...
              ·
                ...
                have weighted_0 := mul_pos (by norm_num : 0 < (541 / 2500 : ℝ)) branch_29_negative
                have weighted_1 := mul_nonneg (by norm_num : 0 ≤ (2701 / 5000 : ℝ)) branch_45
                have weighted_2 := mul_pos (by norm_num : 0 < (73 / 125 : ℝ)) negative
              ...
              ·
                exact branch_48
            ·
              have branch_48_negative : 0 < ((-22 / 25 : ℝ) * square.center.x + (6 / 25 : ℝ) * square.center.y + (124 / 625 : ℝ)) := by linarith only [branch_48]
              apply adjacentR107_hit_boundary square fits 43
              ...
              ·
                ...
                have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (12 / 25 : ℝ)) branch_46
                have weighted_1 := mul_nonneg (by norm_num : 0 ≤ (1 / 4 : ℝ)) branch_47
              ...
              ·
                ...
                have weighted_1 := mul_nonneg (by norm_num : 0 ≤ (1 : ℝ)) branch_45
          ...
          ·
            have branch_47_negative : 0 < ((12 / 25 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-19 / 10 : ℝ)) := by linarith only [branch_47]
            apply adjacentR107_hit_boundary square fits 15
        ...
        ·
          have branch_46_negative : 0 < ((-1 / 4 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-117 / 100 : ℝ)) := by linarith only [branch_46]
          by_cases branch_49 : 0 ≤ ((4 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (-4 / 25 : ℝ))
          ·
            by_cases branch_50 : 0 ≤ ((9 / 100 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (141 / 100 : ℝ))
            ·
              apply adjacentR107_hit_boundary square fits 17
            ...
            ·
              have branch_50_negative : 0 < ((-9 / 100 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-141 / 100 : ℝ)) := by linarith only [branch_50]
              apply adjacentR107_hit_boundary square fits 38
          ...
          ·
            have branch_49_negative : 0 < ((-4 / 25 : ℝ) * square.center.x + (0 : ℝ) * square.center.y + (4 / 25 : ℝ)) := by linarith only [branch_49]
            by_cases branch_51 : 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-3 : ℝ))
            ·
              apply adjacentR107_hit_boundary square fits 26
              ...
              ·
                exact branch_51
            ·
              have branch_51_negative : 0 < ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (3 : ℝ)) := by linarith only [branch_51]
              by_cases branch_52 : 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-71 / 25 : ℝ))
              ·
                apply adjacentR107_hit_boundary square fits 36
              ...
              ·
                have branch_52_negative : 0 < ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (71 / 25 : ℝ)) := by linarith only [branch_52]
                apply adjacentR107_hit_boundary square fits 43
                change 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (71 / 25 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-49 / 25 : ℝ)) ∧ 0 ≤ ((-22 / 25 : ℝ) * square.center.x + (6 / 25 : ℝ) * square.center.y + (124 / 625 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ·
                ...
                ·
                  ...
                  have weighted_0 := mul_pos (by norm_num : 0 < (24 / 625 : ℝ)) branch_46_negative
                  have weighted_1 := mul_pos (by norm_num : 0 < (19 / 50 : ℝ)) branch_49_negative
                  ...
                  nlinarith only [weighted_0, weighted_1, weighted_2, identity]
      ·
        have branch_45_negative : 0 < ((7 / 50 : ℝ) * square.center.x + (-4 / 5 : ℝ) * square.center.y + (839 / 500 : ℝ)) := by linarith only [branch_45]
        by_cases branch_53 : 0 ≤ ((-27 / 50 : ℝ) * square.center.x + (1 / 2 : ℝ) * square.center.y + (-37 / 100 : ℝ))
        ·
          by_cases branch_54 : 0 ≤ ((7 / 50 : ℝ) * square.center.x + (6 / 25 : ℝ) * square.center.y + (-721 / 1250 : ℝ))
          ·
            by_cases branch_55 : 0 ≤ ((2 / 5 : ℝ) * square.center.x + (-37 / 50 : ℝ) * square.center.y + (1433 / 1250 : ℝ))
            ·
              apply adjacentR107_hit_boundary square fits 11
              ...
              ·
                exact branch_54
            ·
              have branch_55_negative : 0 < ((-2 / 5 : ℝ) * square.center.x + (37 / 50 : ℝ) * square.center.y + (-1433 / 1250 : ℝ)) := by linarith only [branch_55]
              by_cases branch_56 : 0 ≤ ((22 / 25 : ℝ) * square.center.x + (-6 / 25 : ℝ) * square.center.y + (-124 / 625 : ℝ))
              ·
                apply adjacentR107_hit_boundary square fits 13
                change 0 ≤ ((-2 / 5 : ℝ) * square.center.x + (37 / 50 : ℝ) * square.center.y + (-1433 / 1250 : ℝ)) ∧ 0 ≤ ((-12 / 25 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (19 / 10 : ℝ)) ∧ 0 ≤ ((22 / 25 : ℝ) * square.center.x + (-6 / 25 : ℝ) * square.center.y + (-124 / 625 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ...
                ·
                  ...
                  have weighted_0 := mul_pos (by norm_num : 0 < (227 / 500 : ℝ)) branch_29_negative
                  have weighted_1 := mul_pos (by norm_num : 0 < (73 / 200 : ℝ)) branch_45_negative
                  have weighted_2 := mul_pos (by norm_num : 0 < (73 / 125 : ℝ)) negative
                ...
                ·
                  exact branch_56
              ·
                have branch_56_negative : 0 < ((-22 / 25 : ℝ) * square.center.x + (6 / 25 : ℝ) * square.center.y + (124 / 625 : ℝ)) := by linarith only [branch_56]
                apply adjacentR107_hit_boundary square fits 43
                change 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (71 / 25 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-49 / 25 : ℝ)) ∧ 0 ≤ ((-22 / 25 : ℝ) * square.center.x + (6 / 25 : ℝ) * square.center.y + (124 / 625 : ℝ))
                refine ⟨?_ , ?_ , ?_ ⟩
                ·
                  ...
                  have weighted_1 := mul_pos (by norm_num : 0 < (1 : ℝ)) branch_45_negative
                  have weighted_2 := mul_pos (by norm_num : 0 < (4 / 5 : ℝ)) negative
                ...
                ·
                  by_contra! failed
                  have negative : 0 < ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (49 / 25 : ℝ)) := by linarith only [failed]
                  have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (2 / 5 : ℝ)) branch_54
                  have weighted_1 := mul_pos (by norm_num : 0 < (7 / 50 : ℝ)) branch_55_negative
          ...
          ·
            have branch_54_negative : 0 < ((-7 / 50 : ℝ) * square.center.x + (-6 / 25 : ℝ) * square.center.y + (721 / 1250 : ℝ)) := by linarith only [branch_54]
            by_cases branch_57 : 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (49 / 25 : ℝ))
            ·
              apply adjacentR107_hit_boundary square fits 35
            ...
            ·
              have branch_57_negative : 0 < ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-49 / 25 : ℝ)) := by linarith only [branch_57]
              apply adjacentR107_hit_boundary square fits 43
              change 0 ≤ ((0 : ℝ) * square.center.x + (-1 : ℝ) * square.center.y + (71 / 25 : ℝ)) ∧ 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-49 / 25 : ℝ)) ∧ 0 ≤ ((-22 / 25 : ℝ) * square.center.x + (6 / 25 : ℝ) * square.center.y + (124 / 625 : ℝ))
              refine ⟨?_ , ?_ , ?_ ⟩
              ·
                ...
                have negative : 0 < ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-71 / 25 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_nonneg (by norm_num : 0 ≤ (7 / 50 : ℝ)) container_0
                have weighted_1 := mul_pos (by norm_num : 0 < (1 : ℝ)) branch_54_negative
                have weighted_2 := mul_pos (by norm_num : 0 < (6 / 25 : ℝ)) negative
                ...
                nlinarith only [weighted_0, weighted_1, weighted_2, constant_negative, identity]
              ·
                exact branch_57_negative.le
              ·
                by_contra! failed
                have negative : 0 < ((22 / 25 : ℝ) * square.center.x + (-6 / 25 : ℝ) * square.center.y + (-124 / 625 : ℝ)) := by linarith only [failed]
                have weighted_0 := mul_pos (by norm_num : 0 < (22 / 25 : ℝ)) branch_54_negative
                have weighted_1 := mul_pos (by norm_num : 0 < (153 / 625 : ℝ)) branch_57_negative
                ...
                nlinarith only [weighted_0, weighted_1, weighted_2, identity]
        ·
          have branch_53_negative : 0 < ((27 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (37 / 100 : ℝ)) := by linarith only [branch_53]
          apply adjacentR107_hit_boundary square fits 12
          change 0 ≤ ((0 : ℝ) * square.center.x + (1 : ℝ) * square.center.y + (-91 / 50 : ℝ)) ∧ 0 ≤ ((-27 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (199 / 100 : ℝ)) ∧ 0 ≤ ((27 / 50 : ℝ) * square.center.x + (-1 / 2 : ℝ) * square.center.y + (37 / 100 : ℝ))
          refine ⟨?_ , ?_ , ?_ ⟩
          ·
          ...
          ·
            ...
            have weighted_0 := mul_pos (by norm_num : 0 < (251 / 500 : ℝ)) branch_29_negative
            have weighted_1 := mul_pos (by norm_num : 0 < (73 / 200 : ℝ)) branch_45_negative
            have weighted_2 := mul_pos (by norm_num : 0 < (73 / 125 : ℝ)) negative
