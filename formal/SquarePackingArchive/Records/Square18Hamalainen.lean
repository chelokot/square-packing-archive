...
namespace SquarePackingArchive.Records.Square18Hamalainen
...
def certificate : QuadraticCertificate 7 18 where
  ...
  squares := #v[
    ...
    { centerX := { rational := ((37 : ℚ) / 16), radical := ((7 : ℚ) / 16) }, centerY := { rational := ((9 : ℚ) / 16), radical := ((5 : ℚ) / 16) }, cosine := { rational := ((1 : ℚ) / 4), radical := ((1 : ℚ) / 4) }, sine := { rational := ((-1 : ℚ) / 4), radical := ((1 : ℚ) / 4) } },
    { centerX := { rational := ((41 : ℚ) / 16), radical := ((3 : ℚ) / 16) }, centerY := { rational := ((13 : ℚ) / 16), radical := ((9 : ℚ) / 16) }, cosine := { rational := ((1 : ℚ) / 4), radical := ((1 : ℚ) / 4) }, sine := { rational := ((-1 : ℚ) / 4), radical := ((1 : ℚ) / 4) } },
    { centerX := { rational := ((49 : ℚ) / 16), radical := ((-3 : ℚ) / 16) }, centerY := { rational := ((27 : ℚ) / 16), radical := ((9 : ℚ) / 16) }, cosine := { rational := ((1 : ℚ) / 4), radical := ((1 : ℚ) / 4) }, sine := { rational := ((-1 : ℚ) / 4), radical := ((1 : ℚ) / 4) } },
    { centerX := { rational := ((53 : ℚ) / 16), radical := ((-7 : ℚ) / 16) }, centerY := { rational := ((31 : ℚ) / 16), radical := ((13 : ℚ) / 16) }, cosine := { rational := ((1 : ℚ) / 4), radical := ((1 : ℚ) / 4) }, sine := { rational := ((-1 : ℚ) / 4), radical := ((1 : ℚ) / 4) } },
    ...
    { centerX := { rational := ((19 : ℚ) / 16), radical := ((1 : ℚ) / 16) }, centerY := { rational := ((47 : ℚ) / 16), radical := ((3 : ℚ) / 16) }, cosine := { rational := ((1 : ℚ) / 4), radical := ((1 : ℚ) / 4) }, sine := { rational := ((-1 : ℚ) / 4), radical := ((1 : ℚ) / 4) } },
    { centerX := { rational := ((15 : ℚ) / 16), radical := ((5 : ℚ) / 16) }, centerY := { rational := ((43 : ℚ) / 16), radical := ((-1 : ℚ) / 16) }, cosine := { rational := ((1 : ℚ) / 4), radical := ((1 : ℚ) / 4) }, sine := { rational := ((-1 : ℚ) / 4), radical := ((1 : ℚ) / 4) } },
    { centerX := { rational := ((7 : ℚ) / 16), radical := ((11 : ℚ) / 16) }, centerY := { rational := ((29 : ℚ) / 16), radical := ((-1 : ℚ) / 16) }, cosine := { rational := ((1 : ℚ) / 4), radical := ((1 : ℚ) / 4) }, sine := { rational := ((-1 : ℚ) / 4), radical := ((1 : ℚ) / 4) } },
    { centerX := { rational := ((3 : ℚ) / 16), radical := ((15 : ℚ) / 16) }, centerY := { rational := ((25 : ℚ) / 16), radical := ((-5 : ℚ) / 16) }, cosine := { rational := ((1 : ℚ) / 4), radical := ((1 : ℚ) / 4) }, sine := { rational := ((-1 : ℚ) / 4), radical := ((1 : ℚ) / 4) } }
  ]
  separatingAxes := #v[
    #v[.leftHorizontal, .leftVertical, .leftVertical, .leftHorizontal, .leftVertical, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftVertical, .leftHorizontal, .leftHorizontal, .leftHorizontal],
    #v[.leftHorizontal, .leftHorizontal, .leftVertical, .leftHorizontal, .leftVertical, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftVertical, .leftHorizontal, .leftHorizontal, .leftHorizontal],
    #v[.leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftVertical, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .rightHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal],
    #v[.leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftVertical, .leftVertical, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftVertical, .leftVertical, .rightHorizontal, .leftHorizontal],
    #v[.leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .rightVertical, .leftHorizontal, .leftHorizontal, .leftHorizontal],
    #v[.leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftVertical, .leftVertical, .leftVertical, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftVertical, .leftVertical, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal],
    #v[.leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftVertical, .leftVertical, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftVertical, .leftVertical, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal],
    #v[.leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftVertical, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftVertical, .leftHorizontal, .leftHorizontal, .leftVertical, .leftVertical],
    #v[.leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftVertical, .leftHorizontal, .leftHorizontal, .leftVertical, .leftVertical],
    ...
    #v[.leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftVertical, .leftVertical],
    ...
    #v[.leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftVertical, .leftVertical, .leftVertical],
    #v[.leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftHorizontal, .leftVertical, .leftVertical],
...
end SquarePackingArchive.Records.Square18Hamalainen
